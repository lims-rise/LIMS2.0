            ...
            <div class="col-xs-12">
                <div class="box box-black box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">Master Data - DNA Sample</h3>
                    </div>
...
?>
		...
		<?php echo anchor(site_url('Ref_allsample/excel'), '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export to CSV', 'class="btn btn-success"'); ?></div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header box">
                    ...
                    <h4 class="modal-title" id="modal-title">Master Data - New sample</h4>
                </div>
                <form id="formSample"  action= <?php echo site_url('Ref_allsample/save') ?> method="post" class="form-horizontal">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #dd4b39; color: white;">
                    ...
                    <h4 class="modal-title"><i class="fa fa-trash"></i> DNA Sample | Delete <span id="my-another-cool-loader"></span></h4>
                </div>
                <div class="modal-body">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.btn_delete', function() {
            let id = $(this).data('id');
            let url = '<?php echo site_url('Ref_allsample/delete'); ?>/' + id;
        ...
        //     $.ajax({
        //         type: "GET",
        //         url: "Ref_allsample/valid_bs?id1="+data1,
        //         data:data1,
        //         dataType: "json",
        ...
        table = $("#mytable").DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "Ref_allsample/json", "type": "POST"},
            columns: [
                // {
                //     "data": "barcode_sample",
                //     "orderable": false
