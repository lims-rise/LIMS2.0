            ...
            <div class="col-xs-12">
                <div class="box box-black box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">NHMRC - IDEXX - In (Food & Hand Rinse)</h3>
                    </div>
...
?>
		...
		<?php echo anchor(site_url('nhmrc_idexx_in/excel'), '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export to CSV', 'class="btn btn-success"'); ?></div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header box">
                    ...
                    <h4 class="modal-title" id="modal-title">NHMRC - IDEXX - In (Food & Hand Rinse)</h4>
                </div>
                <form id="formSample"  action= <?php echo site_url('nhmrc_idexx_in/save') ?> method="post" class="form-horizontal">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="volume2" name="volume2" type="number" step="0.001"  class="form-control" placeholder="Volume-2 (mL) added">
                            </div>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #dd4b39; color: white;">
                    ...
                    <h4 class="modal-title"><i class="fa fa-trash"></i> NHMRC - IDEXX - In (Food & Hand Rinse) | Delete <span id="my-another-cool-loader"></span></h4>
                </div>
                <div class="modal-body">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.btn_delete', function() {
            let id = $(this).data('id');
            let url = '<?php echo site_url('NHMRC_idexx_in/delete'); ?>/' + id;
        ...
        $('#barcode_sample').on("change", function() {
            ...
            $.ajax({
                type: "GET",
                url: "nhmrc_idexx_in/valid_bs?id1="+data1,
                // data:data1,
                dataType: "json",
        ...
        $('#barcode_colilert').on("change", function() {
            ...
            $.ajax({
                type: "GET",
                url: "nhmrc_idexx_in/valid_bs2?id1="+data1,
                // data:data1,
                dataType: "json",
                success: function(data) {
                    // var barcode = '';
        ...
        table = $("#mytable").DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "nhmrc_idexx_in/json", "type": "POST"},
            columns: [
                // {
                //     "data": "barcode_sample",
                //     "orderable": false
        ...
        $('#addtombol').click(function() {
            $('.val1tip').tooltipster('hide');   
            $('#mode').val('insert');
            $('#modal-title').html('<i class="fa fa-wpforms"></i> NHMRC - New IDEXX - In (Food & Hand Rinse)<span id="my-another-cool-loader"></span>');
        ...
        $('#mytable').on('click', '.btn_edit', function(){
            ...
            $('#mode').val('edit');
            $('#modal-title').html('<i class="fa fa-pencil-square"></i> NHMRC - Update IDEXX - In (Food & Hand Rinse)<span id="my-another-cool-loader"></span>');
