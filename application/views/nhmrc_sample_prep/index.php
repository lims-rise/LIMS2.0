        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-black box-solid">
                    <div class="box-header"> <h3 class="box-title">NHMRC - Stomacher (Food)</h3> </div>        
                    <div class="box-body">
                        <div style="padding-bottom: 10px;">
<?php
        $lvl = $this->session->userdata('id_user_level');
        if ($lvl != 7){
            echo "<button class='btn btn-primary' id='addtombol'><i class='fa fa-wpforms' aria-hidden='true'></i> New Stomacher Sample</button>";
        }
?>                            
                            ...
                            <?php echo anchor(site_url('NHMRC_sample_prep/excel'), '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export to CSV', 'class="btn btn-success"'); ?>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header box">
                    ...
                    <h4 class="modal-title" id="modal-title">NHMRC - FOOD - Stomacher</h4>
                </div>
                <form id="formSample"  action= <?php echo site_url('NHMRC_sample_prep/save') ?> method="post" class="form-horizontal">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="barcode_food" class="col-sm-4 control-label">Barcode food</label>
                            <div class="col-sm-8">
                                <input id="barcode_food" name="barcode_food" type="text" class="form-control" placeholder="Barcode food" required>
                                <div class="val2tip"></div>
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="food_weight" class="col-sm-4 control-label">Food Weight (g)</label>
                            <div class="col-sm-3">
                                <input id="food_weight" name="food_weight" type="number" step="0.01" class="form-control" placeholder="Food Weight (g)">
                                <!-- <div class="val1tip"></div> -->
                            </div>
                            <div class="col-sm-5">
                                <input id="food_comments" name="food_comments" type="text" class="form-control" placeholder="Food comments">
                                <!-- <div class="val1tip"></div> -->
                            </div>
                        </div>
    ...
    <div class="modal fade" id="detail-modal2" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="formSample2"  action= <?php echo site_url('nhmrc_bootsocks_stomacher/save_detail2') ?> method="post" class="form-horizontal">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="barcode_food2" class="col-sm-4 control-label">Barcode food</label>
                            <div class="col-sm-8">
                                <input id="barcode_food2" name="barcode_food2" type="text" class="form-control" placeholder="Barcode food" required disabled>
                                <!-- <div class="val1tip"></div> -->
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="barcode_falcon1" class="col-sm-4 control-label">Barcode falcon1</label>
                            <div class="col-sm-8">
                                <input id="barcode_falcon1" name="barcode_falcon1" type="text" class="form-control" placeholder="Barcode falcon1" required>
                                <!-- <div class="val1tip"></div> -->
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="volume_falcon1" class="col-sm-4 control-label">Volume falcon1(mL)</label>
                            <div class="col-sm-8">
                                <input id="volume_falcon1" name="volume_falcon1" type="number" class="form-control" placeholder="Volume falcon1(mL)">
                                <!-- <div class="val1tip"></div> -->
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="barcode_falcon2" name="barcode_falcon2" type="text" class="form-control" placeholder="Barcode falcon2" required>
                                <!-- <div class="val1tip"></div> -->
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="volume_falcon2" class="col-sm-4 control-label">Volume falcon2(mL)</label>
                            <div class="col-sm-8">
                                <input id="volume_falcon2" name="volume_falcon2" type="number" class="form-control" placeholder="Volume falcon2(mL)">
                                <!-- <div class="val1tip"></div> -->
                            </div>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #dd4b39; color: white;">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true" style="color: white;">&times;</button>
                    <h4 class="modal-title"><i class="fa fa-trash"></i> Sample - IDEXX | Delete <span id="my-another-cool-loader"></span></h4>
                </div>
                <div class="modal-body">
                    <div id="confirmation-content">
                        <div class="modal-body">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.btn_delete', function() {
            let id = $(this).data('id');
            let url = '<?php echo site_url('NHMRC_sample_prep/delete'); ?>/' + id;
        ...
        $(document).on('click', '.btn_delete_detail', function() {
            let id = $(this).data('id');
            let url = '<?php echo site_url('NHMRC_sample_prep/delete_det'); ?>/' + id;
        ...
        //     $('#dilution_id').val(($('#volume_falcon_id1').val() + $('#volume_falcon_id2').val())/100);
        // });
        ...
        $('#barcode_sample').on("change", function() {
            ...
            $.ajax({
                type: "GET",
                url: "NHMRC_sample_prep/valid_bs?id1="+data1,
                // data:data1,
                dataType: "json",
        ...
        //     $.ajax({
        //         type: "GET",
        //         url: "NHMRC_sample_prep/valid_boots?id1="+data1,
        //         // data:data1,
        //         dataType: "json",
        //         success: function(data) {
        //             console.log(data);
        ...
        table = $("#mytable").DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "NHMRC_sample_prep/json", "type": "POST"},
            columns: [
                {"data": "barcode_sample"},
                {"data": "date_conduct"},
                {"data": "elution_no"},
        ...
        table_det2 = $("#mytable_det2").DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "NHMRC_sample_prep/subjson2", "type": "POST"},
            columns: [
                // {
                //     "data": "id_bc",
                //     "orderable": false
        ...
        $('#addtombol').click(function() {
            $('#mode').val('insert');
            $('#modal-title').html('<i class="fa fa-wpforms"></i> NHMRC FOOD - New Stomacher<span id="my-another-cool-loader"></span>');
            $('#barcode_sample ').val('');
            // $('#date_conduct').val('');
            $('#elution_no').val('');
            $('#barcode_food').val('');
        ...
        $('#mytable').on('click', '.btn_edit', function(){
            ...
            $('#mode').val('edit');
            $('#modal-title').html('<i class="fa fa-pencil-square"></i> NHMRC FOOD - Update Stomacher<span id="my-another-cool-loader"></span>');
            $('#barcode_sample ').val(data.barcode_sample);
            $('#date_conduct').val(data.date_conduct);
            $('#elution_no').val(data.elution_no).trigger('change');
            $('#barcode_food ').val(data.barcode_food);
        ...
        $('#addtomboldet2').click(function() {
            ...
            $('#detail-title2').html('<i class="fa fa-wpforms"></i> NHMRC - FOOD Stomacher - New IDEXX<span id="my-another-cool-loader"></span>');
            $('#barcode_food2').val(data.barcode_food);
        ...
        $('#mytable_det2').on('click', '.btn_edit_det2', function(){
            ...
            // var data = this.parents('tr').data();
            $('#mode_det2').val('edit');
            $('#detail-title2').html('<i class="fa fa-pencil-square"></i> NHMRC - FOOD Stomacher - Update IDEXX<span id="my-another-cool-loader"></span>');
            $('#barcode_food2').val(data.barcode_food);
            $('#barcode_colilert').attr('readonly', true);
            $('#barcode_colilert').val(data.barcode_colilert);
            $('#barcode_falcon1').val(data.barcode_falcon1);
            $('#volume_falcon1').val(data.volume_falcon1);
            $('#barcode_falcon2').val(data.barcode_falcon2);
            $('#volume_falcon2').val(data.volume_falcon2);
            $('#dilution_id').attr('readonly', true);
        ...
        $('#mytable tbody').on('click', 'tr', function () {
            ...
            if (data) {
                ...
                //     table_det1.ajax.url('NHMRC_sample_prep/subjson?id=' + data.barcode_sample).load();
                // }
                // else {
                //     table_det1.ajax.url('NHMRC_sample_prep/subjson?id=' + data.barcode_bootsock).load();
                // }                
                // table_det1.ajax.url('NHMRC_sample_prep/subjson?id=' + data.barcode_sample).load();
                table_det2.ajax.url('NHMRC_sample_prep/subjson2?id=' + data.barcode_food).load();
            }
        });
