...
?>
                            ...
                            <?php echo anchor(site_url('nhmrc_bootsocks_stomacher/excel'), '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export to CSV', 'class="btn btn-success"'); ?>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header box">
                    ...
                    <h4 class="modal-title" id="modal-title">NHMRC - Bootsocks/Toys Stomacher</h4>
                </div>
                <form id="formSample"  action= <?php echo site_url('nhmrc_bootsocks_stomacher/save') ?> method="post" class="form-horizontal">
            ...
            <div class="modal-content">
                ...
                <form id="formSample2"  action= <?php echo site_url('nhmrc_bootsocks_stomacher/save_detail2') ?> method="post" class="form-horizontal">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="barcode_bootsock2" class="col-sm-4 control-label">Barcode bootsocks/toys</label>
                            <div class="col-sm-8">
                                <input id="barcode_bootsock2" name="barcode_bootsock2" type="text" class="form-control" placeholder="Barcode bootsock/toys" required>
                                <!-- <div class="val1tip"></div> -->
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.btn_delete', function() {
            let id = $(this).data('id');
            let url = '<?php echo site_url('NHMRC_bootsocks_stomacher/delete'); ?>/' + id;
        ...
        $(document).on('click', '.btn_delete_detail', function() {
            let id = $(this).data('id');
            let url = '<?php echo site_url('NHMRC_bootsocks_stomacher/delete_det'); ?>/' + id;
        ...
        $('#barcode_sample').on("change", function() {
            ...
            $.ajax({
                type: "GET",
                url: "nhmrc_bootsocks_stomacher/valid_bs?id1="+data1,
                // data:data1,
                dataType: "json",
        ...
        //     $.ajax({
        //         type: "GET",
        //         url: "nhmrc_bootsocks_stomacher/valid_boots?id1="+data1,
        //         // data:data1,
        //         dataType: "json",
        //         success: function(data) {
        //             console.log(data);
        ...
        table = $("#mytable").DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "nhmrc_bootsocks_stomacher/json", "type": "POST"},
            columns: [
                {"data": "barcode_sample"},
                {"data": "date_conduct"},
                {"data": "elution_no"},
        ...
        table_det2 = $("#mytable_det2").DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "nhmrc_bootsocks_stomacher/subjson2", "type": "POST"},
            columns: [
                // {
                //     "data": "id_bc",
                //     "orderable": false
        ...
        $('#addtombol').click(function() {
            $('#mode').val('insert');
            $('#modal-title').html('<i class="fa fa-wpforms"></i> NHMRC - New Bootsocks/toys Stomacher<span id="my-another-cool-loader"></span>');
            $('#barcode_sample ').val('');
            // $('#date_conduct').val('');
            $('#elution_no').val('');
            $('#barcode_bootsock').val('');
        ...
        $('#addtomboldet2').click(function() {
            ...
            $('#detail-title2').html('<i class="fa fa-wpforms"></i> NHMRC - New IDEXX<span id="my-another-cool-loader"></span>');
        ...
        $('#mytable').on('click', '.btn_edit', function(){
            ...
            $('#mode').val('edit');
            $('#modal-title').html('<i class="fa fa-pencil-square"></i> NHMRC - Update Bootsocks/toys Stomacher<span id="my-another-cool-loader"></span>');
        ...
        $('#mytable_det2').on('click', '.btn_edit_det2', function(){
            ...
            // var data = this.parents('tr').data();
            $('#mode_det2').val('edit');
            $('#detail-title2').html('<i class="fa fa-pencil-square"></i> NHMRC - Update IDEXX<span id="my-another-cool-loader"></span>');
            $('#barcode_bootsock2').attr('readonly', true);
        ...
        $('#mytable tbody').on('click', 'tr', function () {
            ...
            if (data) {
                ...
                //     table_det1.ajax.url('nhmrc_bootsocks_stomacher/subjson?id=' + data.barcode_sample).load();
                // }
                // else {
                //     table_det1.ajax.url('nhmrc_bootsocks_stomacher/subjson?id=' + data.barcode_bootsock).load();
                // }                
                table_det2.ajax.url('nhmrc_bootsocks_stomacher/subjson2?id=' + data.barcode_bootsock).load();
            }
        });
