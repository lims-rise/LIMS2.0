<div class="content-wrapper">
    <section class="content">
            ...
            <div class="col-xs-12">
                <div class="box box-black box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">Objective 2B - IDEXX - Out (All)</h3>
                    </div>
        
        <div class="box-body">
        <div style="padding-bottom: 10px;">
        <button class='btn btn-primary' id='addtombol'><i class="fa fa-wpforms" aria-hidden="true"></i> New IDEXX IN</button>
		...
		<?php echo anchor(site_url('O2b_idexx_out/excel'), '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export to CSV', 'class="btn btn-success"'); ?></div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header box">
                    ...
                    <h4 class="modal-title" id="modal-title">O2B - IDEXX - Out (All)</h4>
                </div>
                <form id="formSample"  action= <?php echo site_url('O2b_idexx_out/save') ?> method="post" class="form-horizontal">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        function load_dilution(data1) {
            $.ajax({
                type: "GET",
                url: "O2b_idexx_out/load_dilution?id1="+data1,
                dataType: "json",
        ...
        $('#barcode_colilert').on("change", function() {
            ...
            $.ajax({
                type: "GET",
                url: "O2b_idexx_out/valid_bs?id1="+data1,
                dataType: "json",
                success: function(data) {
                    if (data.length > 0) {
                        // $('#date_conduct_in').val(data[0].date_cond);     
        ...
        table = $("#mytable").DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "O2b_idexx_out/json", "type": "POST"},
            columns: [
                // {
                //     "data": "barcode_sample",
                //     "orderable": false
