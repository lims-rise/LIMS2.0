            ...
            <div class="col-xs-12">
                <div class="box box-black box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">Objective 2B - Moisture 72h</h3>
                    </div>
...
?>
		...
		<?php echo anchor(site_url('O2b_moisture_72/excel'), '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export to CSV', 'class="btn btn-success"'); ?></div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header box">
                    ...
                    <h4 class="modal-title" id="modal-title">O2B - Moisture 72h</h4>
                </div>
                <form id="formSample"  action= <?php echo site_url('O2b_moisture_72/save') ?> method="post" class="form-horizontal">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        //     $.ajax({
        //         type: "GET",
        //         url: "O2b_moisture_72/load_freez?id1="+data1,
        //         dataType: "json",
        ...
        //     $.ajax({
        //         type: "GET",
        //         url: "O2b_moisture_72/get_freez?id1="+data1+"&id2="+data2+"&id3="+data3+"&id4="+data4,
        //         dataType: "json",
        //         success: function(data) {
        //             if (data.length > 0) {
        //                 // console.log();
        ...
        $('#barcode_foil').on("change", function() {
            ...
            $.ajax({
                type: "GET",
                url: "O2b_moisture_72/valid_bs?id1="+data1,
                // data:data1,
                dataType: "json",
                success: function(data) {
                    // var barcode = '';
        ...
        table = $("#mytable").DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "O2b_moisture_72/json", "type": "POST"},
            columns: [
                // {
                //     "data": "barcode_sample",
                //     "orderable": false
        ...
        $('#addtombol').click(function() {
            $('.val1tip').tooltipster('hide');   
            $('#mode').val('insert');
            $('#modal-title').html('<i class="fa fa-wpforms"></i> O2B - New Moisture 72h<span id="my-another-cool-loader"></span>');
        ...
        $('#mytable').on('click', '.btn_edit', function(){
            ...
            $('#mode').val('edit');
            $('#modal-title').html('<i class="fa fa-pencil-square"></i> O2B - Update Moisture 72h<span id="my-another-cool-loader"></span>');
