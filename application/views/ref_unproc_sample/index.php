            ...
            <div class="col-xs-12">
                <div class="box box-black box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">Master Data - Unprocessed sample</h3>
                    </div>
...
$lvl = $this->session->userdata('id_user_level');
        if ($lvl != 7){
            echo "<button class='btn btn-primary' id='addtombol'><i class='fa fa-wpforms' aria-hidden='true'></i> New Unprocessed sample</button>";
        }
?>
        
		<?php echo anchor(site_url('Ref_unproc_sample/excel'), '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export to CSV', 'class="btn btn-success"'); ?></div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header box">
                    ...
                    <h4 class="modal-title" id="modal-title">Master Data - Unprocessed sample</h4>
                </div>
                <form id="formSample"  action= <?php echo site_url('Ref_unproc_sample/save') ?> method="post" class="form-horizontal">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="date_entry" class="col-sm-4 control-label">Date entry</label>
                            <div class="col-sm-8">
                                <input id="date_entry" name="date_entry" type="date" class="form-control" placeholder="Date entry" value="<?php echo date("Y-m-d"); ?>">
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="time_entry" class="col-sm-4 control-label">Time entry</label>
                            <div class="col-sm-8">
                                <div class="input-group clockpicker">
                                <input id="time_entry" name="time_entry" class="form-control" placeholder="Time entry" value="<?php 
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #dd4b39; color: white;">
                    ...
                    <h4 class="modal-title"><i class="fa fa-trash"></i> Unprocessed sample | Delete <span id="my-another-cool-loader"></span></h4>
                </div>
                <div class="modal-body">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.btn_delete', function() {
            let id = $(this).data('id');
            let url = '<?php echo site_url('Ref_unproc_sample/delete'); ?>/' + id;
        ...
        //     $.ajax({
        //         type: "GET",
        //         url: "Ref_unproc_sample/valid_bs?id1="+data1,
        //         data:data1,
        //         dataType: "json",
        ...
        table = $("#mytable").DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "Ref_unproc_sample/json", "type": "POST"},
            columns: [
                // {
                //     "data": "barcode_sample",
                //     "orderable": false
        ...
        $('#addtombol').click(function() {
            ...
            $('#barcode_sample').val('');
            // $("#date_entry").datepicker("setDate",'now');
            // $('#time_entry').timepicker('setTime', new Date());
            $('#comments').val('');
        ...
        $('#mytable').on('click', '.btn_edit', function(){
            ...
            $('#date_entry').val(data.date_entry);
            $('#time_entry').val(data.time_entry);
