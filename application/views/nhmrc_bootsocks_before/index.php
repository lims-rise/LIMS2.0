        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-black box-solid">
                    <div class="box-header"> <h3 class="box-title">NHMRC - Bootsocks/Toys Before</h3> </div>        
                    <div class="box-body">
...
?>
                            ...
                            <?php echo anchor(site_url('nhmrc_bootsocks_before/excel'), '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export to CSV', 'class="btn btn-success"'); ?>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header box">
                    ...
                    <h4 class="modal-title" id="modal-title">New BOOTSOCKS/TOYS - weights (before sample collection)</h4>
                </div>
                <form id="formSample"  action= <?php echo site_url('nhmrc_bootsocks_before/save') ?> method="post" class="form-horizontal">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="bootsock_weight_dry" class="col-sm-4 control-label">Weight - dry (g)</label>
                            <div class="col-sm-8">
                                <input id="bootsock_weight_dry" name="bootsock_weight_dry" type="number" step="0.01" class="form-control" placeholder="Weight - dry (g)" required>
                            </div>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #dd4b39; color: white;">
                    ...
                    <h4 class="modal-title"><i class="fa fa-trash"></i> NHMRC - Bootsocks/Toys Before | Delete <span id="my-another-cool-loader"></span></h4>
                </div>
                <div class="modal-body">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.btn_delete', function() {
            let id = $(this).data('id');
            let url = '<?php echo site_url('NHMRC_bootsocks_before/delete'); ?>/' + id;
        ...
        $('#barcode_bootsocks').on("change", function() {
            ...
            $.ajax({
                type: "GET",
                url: "nhmrc_bootsocks_before/valid_bs?id1="+data1+"&id2=1",
                data:data1,
                dataType: "json",
        ...
        table = $("#mytable").DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "nhmrc_bootsocks_before/json", "type": "POST"},
            columns: [
                // {
                //     "data": "id",
                //     "orderable": false
        ...
        $('#addtombol').click(function() {
            $('#mode').val('insert');
            $('#modal-title').html('<i class="fa fa-wpforms"></i> NHMRC - New BOOTSOCKS/TOYS - weights (before sample collection)<span id="my-another-cool-loader"></span>');
            $('#barcode_bootsocks').val('');
        ...
        $('#mytable').on('click', '.btn_edit', function(){
            ...
            console.log(data);
            $('#mode').val('edit');
            $('#modal-title').html('<i class="fa fa-pencil-square"></i> NHMRC - Update BOOTSOCKS/TOYS - weights (before sample collection)<span id="my-another-cool-loader"></span>');
        ...
        $('#mytable tbody').on('click', 'tr', function () {
            ...
            // if (data) {
            //     table_det.ajax.url('nhmrc_bootsocks_before/subjson?id=' + data.id_receipt).load();
            // }
        });
