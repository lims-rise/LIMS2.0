<div class="content-wrapper">
    <section class="content">
            ...
            <div class="col-xs-12">
                <div class="box box-black box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">Objective 2B - Endetec - In (Water)</h3>
                    </div>
        
        <div class="box-body">
        <div style="padding-bottom: 10px;">
        <button class='btn btn-primary' id='addtombol'><i class="fa fa-wpforms" aria-hidden="true"></i> New endetec IN</button>
		...
		<?php echo anchor(site_url('O2b_endetec_in/excel'), '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export to CSV', 'class="btn btn-success"'); ?></div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header box">
                    ...
                    <h4 class="modal-title" id="modal-title">O2B - Endetec - In (Water)</h4>
                </div>
                <form id="formSample"  action= <?php echo site_url('O2b_endetec_in/save') ?> method="post" class="form-horizontal">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#barcode_sample').on("change", function() {
            ...
            $.ajax({
                type: "GET",
                url: "O2b_endetec_in/valid_bs?id1="+data1,
                // data:data1,
                dataType: "json",
        ...
        $('#barcode_endetec').on("change", function() {
            ...
            $.ajax({
                type: "GET",
                url: "O2b_endetec_in/valid_bs2?id1="+data1+"&id2="+data2,
                // data:data1,
                dataType: "json",
                success: function(data) {
                    // var barcode = '';
                    if (data.length > 0) {
                        tip = $('<span><i class="fa fa-exclamation-triangle"></i> Barcode endetec <strong> ' + data1 +'</strong> is already in the system !</span>');
        ...
        table = $("#mytable").DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "O2b_endetec_in/json", "type": "POST"},
            columns: [
                // {
                //     "data": "barcode_sample",
                //     "orderable": false
        ...
        $('#addtombol').click(function() {
            $('.val1tip').tooltipster('hide');   
            $('#mode').val('insert');
            $('#modal-title').html('<i class="fa fa-wpforms"></i> O2B - New Endetec - In (Water)<span id="my-another-cool-loader"></span>');
        ...
        $('#mytable').on('click', '.btn_edit', function(){
            ...
            $('#mode').val('edit');
            $('#modal-title').html('<i class="fa fa-pencil-square"></i> O2B - Update Endetec - In (Water)<span id="my-another-cool-loader"></span>');
