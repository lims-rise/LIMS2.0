            ...
            <div class="col-xs-12">
                <div class="box box-black box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">Objective 2B - Metagenomics (Water & Bootsocks)</h3>
                    </div>
...
<?php
        ...
        if ($lvl != 7){
            echo "<button class='btn btn-primary' id='addtombol'><i class='fa fa-wpforms' aria-hidden='true'></i> New Metagenomics (W/B)</button>";
        }
?>
		...
		<?php echo anchor(site_url('O2b_metagenomics_wb/excel'), '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export to CSV', 'class="btn btn-success"'); ?></div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header box">
                    ...
                    <h4 class="modal-title" id="modal-title">O2B - Metagenomics (Water & Bootsocks)</h4>
                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        function load_freez(data1) {
            $.ajax({
                type: "GET",
                url: "O2b_metagenomics_wb/load_freez?id1="+data1,
                dataType: "json",
        ...
        function get_freez(data1, data2, data3, data4) {
            $.ajax({
                type: "GET",
                url: "O2b_metagenomics_wb/get_freez?id1="+data1+"&id2="+data2+"&id3="+data3+"&id4="+data4,
                dataType: "json",
                success: function(data) {
                    if (data.length > 0) {
                        // console.log();
        ...
        $('#barcode_dna_bag').on("change", function() {
            ...
            $.ajax({
                type: "GET",
                url: "O2b_metagenomics_wb/valid_dna?id1="+data1,
                // data:data1,
                dataType: "json",
                success: function(data) {
                    // var barcode = '';
        ...
        table = $("#mytable").DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "o2b_metagenomics_wb/json", "type": "POST"},
            columns: [
                // {
                //     "data": "barcode_sample",
                //     "orderable": false
        ...
        $('#addtombol').click(function() {
            $('.val1tip').tooltipster('hide');   
            $('#mode').val('insert');
            $('#modal-title').html('<i class="fa fa-wpforms"></i> O2B - New Metagenomics (water & bootsocks)<span id="my-another-cool-loader"></span>');
        ...
        $('#mytable').on('click', '.btn_edit', function(){
            ...
            $('#mode').val('edit');
            $('#modal-title').html('<i class="fa fa-pencil-square"></i> O2B - Update Metagenomics (water & bootsocks)<span id="my-another-cool-loader"></span>');
