        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-black box-solid">
                    <div class="box-header"> <h3 class="box-title">Objective 2B - Bootsocks After</h3> </div>        
                    <div class="box-body">
                        <div style="padding-bottom: 10px;">
                            <button class='btn btn-primary' id='addtombol'><i class="fa fa-wpforms" aria-hidden="true"></i> New Bootsock </button>
                            ...
                            <?php echo anchor(site_url('o2b_bootsocks_after/excel'), '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export to CSV', 'class="btn btn-success"'); ?>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header box">
                    ...
                    <h4 class="modal-title" id="modal-title">New BOOTSOCKS - weights (after sample collection)</h4>
                </div>
                <form id="formSample"  action= <?php echo site_url('o2b_bootsocks_after/save') ?> method="post" class="form-horizontal">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#barcode_bootsocks').on("change", function() {
            ...
            $.ajax({
                type: "GET",
                url: "o2b_bootsocks_after/valid_bs?id1="+data1+"&id2=1",
                data:data1,
                dataType: "json",
        ...
        table = $("#mytable").DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "o2b_bootsocks_after/json", "type": "POST"},
            columns: [
                // {
                //     "data": "id",
                //     "orderable": false
        ...
        $('#addtombol').click(function() {
            $('#mode').val('insert');
            $('#modal-title').html('<i class="fa fa-wpforms"></i> O2B - New BOOTSOCKS - weights (after sample collection)<span id="my-another-cool-loader"></span>');
            $('#barcode_bootsocks').val('');
        ...
        $('#mytable').on('click', '.btn_edit', function(){
            ...
            console.log(data);
            $('#mode').val('edit');
            $('#modal-title').html('<i class="fa fa-pencil-square"></i> O2B - Update BOOTSOCKS - weights (after sample collection)<span id="my-another-cool-loader"></span>');
        ...
        $('#mytable tbody').on('click', 'tr', function () {
            ...
            // if (data) {
            //     table_det.ajax.url('o2b_bootsocks_after/subjson?id=' + data.id_receipt).load();
            // }
        });
