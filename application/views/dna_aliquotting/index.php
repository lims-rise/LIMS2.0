...
<?php
        ...
        if ($lvl != 7){
            echo "<button class='btn btn-primary' id='addtombol'><i class='fa fa-wpforms' aria-hidden='true'></i> New DNA Aliquotting </button>";
        }
?>        
		<?php echo anchor(site_url('dna_aliquotting/excel'), '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export to CSV', 'class="btn btn-success"'); ?></div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header box">
                    ...
                    <h4 class="modal-title" id="modal-title">DNA - New DNA Aliquot</h4>
                </div>
                <form id="formSample"  action= <?php echo site_url('dna_aliquotting/save') ?> method="post" class="form-horizontal">
                    <div class="modal-body">
                        <input id="mode" name="mode" type="hidden" class="form-control input-sm">

                        <div class="form-group">
                            <label for="date_aliquot" class="col-sm-4 control-label">Date aliquot</label>
                            <div class="col-sm-8">
                                <input id="date_aliquot" name="date_aliquot" type="date" class="form-control" placeholder="Date aliquot" value="<?php echo date("Y-m-d"); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="barcode_monash" class="col-sm-4 control-label">Barcode Monash</label>
                            <div class="col-sm-8">
                                <input id="barcode_monash" name="barcode_monash" type="text" class="form-control" placeholder="Barcode Monash">
                                <!-- <div class="val1tip"></div> -->
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="barcode_cambridge" class="col-sm-4 control-label">Barcode Cambridge</label>
                            <div class="col-sm-8">
                                <input id="barcode_cambridge" name="barcode_cambridge" type="text" class="form-control" placeholder="Barcode Cambridge">
                                <!-- <div class="val1tip"></div> -->
                            </div>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #dd4b39; color: white;">
                    ...
                    <h4 class="modal-title"><i class="fa fa-trash"></i> DNA Aliquotting | Delete <span id="my-another-cool-loader"></span></h4>
                </div>
                <div class="modal-body">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.btn_delete', function() {
            let id = $(this).data('id');
            let url = '<?php echo site_url('Dna_aliquotting/delete'); ?>/' + id;
        ...
        //     $.ajax({
        //         type: "GET",
        //         url: "dna_aliquotting/get_dna_type?id1="+data1,
        //         // data:data1,
        //         dataType: "json",
        ...
        table = $("#mytable").DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "dna_aliquotting/json", "type": "POST"},
            columns: [
                // {
                //     "data": "barcode_sample",
                //     "orderable": false
        ...
        $('#addtombol').click(function() {
            // $('.val1tip').tooltipster('hide');   
            $('#mode').val('insert');
            $('#modal-title').html('<i class="fa fa-wpforms"></i> DNA - New DNA Aliquot<span id="my-another-cool-loader"></span>');
            // $('#barcode_dna').attr('readonly', false);
            // $('#barcode_dna').val('');
            $('#id_dna').val('');
            $('#id_person').val('');
            $('#barcode_monash').val('');
            $('#barcode_cambridge').val('');
        ...
        $('#mytable').on('click', '.btn_edit', function(){
            ...
            $('#mode').val('edit');
            $('#modal-title').html('<i class="fa fa-pencil-square"></i> DNA - Update DNA Aliquot<span id="my-another-cool-loader"></span>');
            $('#id_dna').val(data.id_dna);
            // $('#barcode_dna').attr('readonly', true);
            // $('#barcode_dna').val(data.barcode_dna);
            $('#date_aliquot').val(data.date_aliquot);
            $('#id_person').val(data.id_person).trigger('change');
            $('#barcode_monash').val(data.barcode_monash);
            $('#barcode_cambridge').val(data.barcode_cambridge);
