...
<html>
    <head>
        ...
        <title>LIMS RISE Application</title>
        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="<?php echo base_url() ?>index.php/welcome" class="logo">
                    ...
                    <span class="logo-lg">RISE|<b>LIMS2.0</b></span>
                ...
                <nav class="navbar navbar-static-top">
                    ...
                    <?php 
                        ...
                        if ($this->session->userdata('lab') == 1) {
                            ...
                            echo "<h6><i class='fa fa-qrcode'></i> Indonesia Laboratory Data </h6>";
                        }
                        else {
                            echo "<h6><i class='fa fa-qrcode'></i> Fiji Laboratory Data </h6>";
