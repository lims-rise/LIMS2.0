            ...
            <div class="col-xs-12">
                <div class="box box-black box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">NHMRC - Moisture 24h</h3>
                    </div>
...
<?php
        ...
        if ($lvl != 7){
            echo "<button class='btn btn-primary' id='addtombol'><i class='fa fa-wpforms' aria-hidden='true'></i> New Moisture 24h</button>";
        }
?>
		...
		<?php echo anchor(site_url('nhmrc_moisture_24/excel'), '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export to CSV', 'class="btn btn-success"'); ?></div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header box">
                    ...
                    <h4 class="modal-title" id="modal-title">NHMRC - Moisture 24h</h4>
                </div>
                <form id="formSample"  action= <?php echo site_url('nhmrc_moisture_24/save') ?> method="post" class="form-horizontal">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="dry_weight24" name="dry_weight24" type="number" step="0.01"  class="form-control" placeholder="Dry weight 24h (g)" required>
                            </div>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #dd4b39; color: white;">
                    ...
                    <h4 class="modal-title"><i class="fa fa-trash"></i> NHMRC - Moisture 24h | Delete <span id="my-another-cool-loader"></span></h4>
                </div>
                <div class="modal-body">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.btn_delete', function() {
            let id = $(this).data('id');
            let url = '<?php echo site_url('NHMRC_moisture_24/delete'); ?>/' + id;
        ...
        //     $.ajax({
        //         type: "GET",
        //         url: "nhmrc_moisture_24/load_freez?id1="+data1,
        //         dataType: "json",
        ...
        //     $.ajax({
        //         type: "GET",
        //         url: "nhmrc_moisture_24/get_freez?id1="+data1+"&id2="+data2+"&id3="+data3+"&id4="+data4,
        //         dataType: "json",
        //         success: function(data) {
        //             if (data.length > 0) {
        //                 // console.log();
        ...
        $('#barcode_foil').on("change", function() {
            ...
            $.ajax({
                type: "GET",
                url: "nhmrc_moisture_24/valid_bs?id1="+data1,
                // data:data1,
                dataType: "json",
                success: function(data) {
                    // var barcode = '';
        ...
        table = $("#mytable").DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "nhmrc_moisture_24/json", "type": "POST"},
            columns: [
                // {
                //     "data": "barcode_sample",
                //     "orderable": false
        ...
        $('#addtombol').click(function() {
            $('.val1tip').tooltipster('hide');   
            $('#mode').val('insert');
            $('#modal-title').html('<i class="fa fa-wpforms"></i> NHMRC - New Moisture 24h<span id="my-another-cool-loader"></span>');
        ...
        $('#mytable').on('click', '.btn_edit', function(){
            ...
            $('#mode').val('edit');
            $('#modal-title').html('<i class="fa fa-pencil-square"></i> NHMRC - Update Moisture 24h<span id="my-another-cool-loader"></span>');
