            ...
            <div class="col-xs-12">
                <div class="box box-black box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">Master Data - Destination</h3>
                    </div>
...
<?php
        ...
        if ($lvl != 7){
            echo "<button class='btn btn-primary' id='addtombol'><i class='fa fa-wpforms' aria-hidden='true'></i> New Destination </button>";
        }
?>        
    ...
    <div class="modal fade" id="compose-modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="formSample"  action= <?php echo site_url('Ref_destination/save') ?> method="post" class="form-horizontal">
                    <div class="modal-body">
                        <input id="mode" name="mode" type="hidden" class="form-control input-sm">
                        <input id="id_destination" name="id_destination" type="hidden" class="form-control input-sm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="destination" name="destination" type="text" class="form-control" placeholder="Destination" value="<?php echo date("Y-m-d"); ?>">
                            </div>
                            </div>
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #dd4b39; color: white;">
                    ...
                    <h4 class="modal-title"><i class="fa fa-trash"></i> Destination | Delete <span id="my-another-cool-loader"></span></h4>
                </div>
                <div class="modal-body">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.btn_delete', function() {
            let id = $(this).data('id');
            let url = '<?php echo site_url('Ref_destination/delete'); ?>/' + id;
        ...
        //     $.ajax({
        //         type: "GET",
        //         url: "Ref_destination/valid_bs?id1="+data1,
        //         data:data1,
        //         dataType: "json",
        ...
        table = $("#mytable").DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "Ref_destination/json", "type": "POST"},
            columns: [
                // {
                //     "data": "barcode_sample",
                //     "orderable": false
        ...
        $('#addtombol').click(function() {
            $('.val1tip').tooltipster('hide');   
            $('#mode').val('insert');
            $('#modal-title').html('<i class="fa fa-wpforms"></i> Master Data - New destination<span id="my-another-cool-loader"></span>');
            $('#id_destination').val('');
        ...
        $('#mytable').on('click', '.btn_edit', function(){
            ...
            $('#mode').val('edit');
            $('#modal-title').html('<i class="fa fa-pencil-square"></i> Master Data - Update destination<span id="my-another-cool-loader"></span>');
