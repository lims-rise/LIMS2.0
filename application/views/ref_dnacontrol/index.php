            ...
            <div class="col-xs-12">
                <div class="box box-black box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">Master Data - DNA Control</h3>
                    </div>
...
?>
		...
		<?php echo anchor(site_url('ref_dnacontrol/excel'), '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export to CSV', 'class="btn btn-success"'); ?></div>
        <table class="table table-bordered table-striped tbody" id="mytable" style="width:100%">
            <thead>
                <tr>
                    <!-- <th width="30px">No</th> -->
		    <th>ID</th>
		    <th>Sample Control</th>
		    <th>Action</th>
                </tr>
            </thead>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header box">
                    ...
                    <h4 class="modal-title" id="modal-title">Master Data - New sample control</h4>
                </div>
                <form id="formSample"  action= <?php echo site_url('ref_dnacontrol/save') ?> method="post" class="form-horizontal">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="sample" class="col-sm-4 control-label">Sample Control</label>
                            <div class="col-sm-8">
                                <input id="sample" name="sample" type="text" class="form-control" placeholder="Sample Control" value="<?php echo date("Y-m-d"); ?>">
                            </div>
                            </div>
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #dd4b39; color: white;">
                    ...
                    <h4 class="modal-title"><i class="fa fa-trash"></i> DNA Control | Delete <span id="my-another-cool-loader"></span></h4>
                </div>
                <div class="modal-body">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.btn_delete', function() {
            let id = $(this).data('id');
            let url = '<?php echo site_url('ref_dnacontrol/delete'); ?>/' + id;
        ...
        //     $.ajax({
        //         type: "GET",
        //         url: "ref_dnacontrol/valid_bs?id1="+data1,
        //         data:data1,
        //         dataType: "json",
        ...
        table = $("#mytable").DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "ref_dnacontrol/json", "type": "POST"},
            columns: [
                // {
                //     "data": "barcode_sample",
                //     "orderable": false
        ...
        $('#addtombol').click(function() {
            $('.val1tip').tooltipster('hide');   
            $('#mode').val('insert');
            $('#modal-title').html('<i class="fa fa-wpforms"></i> Master Data - New sample control<span id="my-another-cool-loader"></span>');
            $('#id_sample').val('');
        ...
        $('#mytable').on('click', '.btn_edit', function(){
            ...
            $('#mode').val('edit');
            $('#modal-title').html('<i class="fa fa-pencil-square"></i> Master Data - Update sample control<span id="my-another-cool-loader"></span>');
