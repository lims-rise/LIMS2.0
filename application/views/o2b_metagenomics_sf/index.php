            ...
            <div class="col-xs-12">
                <div class="box box-black box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">Objective 2B - Metagenomics (Sediment & Feces)</h3>
                    </div>
...
<?php
        ...
        if ($lvl != 7){
            echo "<button class='btn btn-primary' id='addtombol'><i class='fa fa-wpforms' aria-hidden='true'></i> New Metagenomics (S/F)</button>";
        }
?>
		...
		<?php echo anchor(site_url('O2b_metagenomics_sf/excel'), '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export to CSV', 'class="btn btn-success"'); ?></div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header box">
                    ...
                    <h4 class="modal-title" id="modal-title">O2B - Metagenomics (Sediment & Feces)</h4>
                </div>
                <form id="formSample"  action= <?php echo site_url('O2b_metagenomics_sf/save') ?> method="post" class="form-horizontal">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        function load_freez1(data1) {
            $.ajax({
                type: "GET",
                url: "O2b_metagenomics_sf/load_freez?id1="+data1,
                dataType: "json",
        ...
        function get_freez1(data1, data2, data3, data4) {
            $.ajax({
                type: "GET",
                url: "O2b_metagenomics_sf/get_freez?id1="+data1+"&id2="+data2+"&id3="+data3+"&id4="+data4,
                dataType: "json",
                success: function(data) {
                    if (data.length > 0) {
                        // console.log();
        ...
        $('#barcode_sample').on("change", function() {
            ...
            $.ajax({
                type: "GET",
                url: "O2b_metagenomics_sf/valid_bs?id1="+data1,
                // data:data1,
                dataType: "json",
                success: function(data) {
                    // var barcode = '';
        ...
        $('#barcode_dna1').on("change", function() {
            ...
            $.ajax({
                type: "GET",
                url: "O2b_metagenomics_sf/valid_bs2?id1="+data1,
                // data:data1,
                dataType: "json",
                success: function(data) {
                    // var barcode = '';
        ...
        table = $("#mytable").DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "O2b_metagenomics_sf/json", "type": "POST"},
            columns: [
                // {
                //     "data": "barcode_sample",
                //     "orderable": false
        ...
        $('#addtombol').click(function() {
            $('.val1tip').tooltipster('hide');   
            $('#mode').val('insert');
            $('#modal-title').html('<i class="fa fa-wpforms"></i> O2B - New Metagenomics (sediment & feces)<span id="my-another-cool-loader"></span>');
        ...
        $('#mytable').on('click', '.btn_edit', function(){
            ...
            $('#mode').val('edit');
            $('#modal-title').html('<i class="fa fa-pencil-square"></i> O2B - Update Metagenomics (sediment & feces)<span id="my-another-cool-loader"></span>');
