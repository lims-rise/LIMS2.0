...
<?php
        ...
        if ($lvl != 7){
            echo "<button class='btn btn-primary' id='addtombol'><i class='fa fa-wpforms' aria-hidden='true'></i> New Person </button>";
        }
?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header box">
                    ...
                    <h4 class="modal-title" id="modal-title">Master Data - New Person</h4>
                </div>
                <form id="formSample"  action= <?php echo site_url('Ref_person/save') ?> method="post" class="form-horizontal">
                    <div class="modal-body">
                        <input id="mode" name="mode" type="hidden" class="form-control input-sm">
                        <input id="id_person" name="id_person" type="hidden" class="form-control input-sm">
                        ...
                        <div class="form-group">
                            <label for="realname" class="col-sm-4 control-label">Real name</label>
                            <div class="col-sm-8">
                                <input id="realname" name="realname" type="text" class="form-control" placeholder="Real name" value="<?php echo date("Y-m-d"); ?>">
                            </div>
                            </div>

                        <div class="form-group">
                            <label for="initial" class="col-sm-4 control-label">Initial</label>
                            <div class="col-sm-8">
                                <input id="initial" name="initial" type="text" class="form-control" placeholder="Initial" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="position" name="position" type="text" class="form-control" placeholder="Position" required>
                            </div>
                        </div>
                        <!-- <div class="form-group">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #dd4b39; color: white;">
                    ...
                    <h4 class="modal-title"><i class="fa fa-trash"></i> Person | Delete <span id="my-another-cool-loader"></span></h4>
                </div>
                <div class="modal-body">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.btn_delete', function() {
            let id = $(this).data('id');
            let url = '<?php echo site_url('Ref_person/delete'); ?>/' + id;
        ...
        //     $.ajax({
        //         type: "GET",
        //         url: "Ref_person/valid_bs?id1="+data1,
        //         data:data1,
        //         dataType: "json",
        ...
        table = $("#mytable").DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "Ref_person/json", "type": "POST"},
            columns: [
                // {
                //     "data": "barcode_sample",
                //     "orderable": false
        ...
        $('#addtombol').click(function() {
            $('.val1tip').tooltipster('hide');   
            $('#mode').val('insert');
            $('#modal-title').html('<i class="fa fa-wpforms"></i> Master Data - New Person<span id="my-another-cool-loader"></span>');
            $('#id_person').val('');
        ...
        $('#mytable').on('click', '.btn_edit', function(){
            ...
            $('#mode').val('edit');
            $('#modal-title').html('<i class="fa fa-pencil-square"></i> Master Data - Update Person<span id="my-another-cool-loader"></span>');
