             ...
             <div class="col-xs-12">
                <div class="box box-primary box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">REPORTS - Objective 2A REPORT</h3>
                    </div>
                    <div class="box-body">
                        <!-- <button> </button> -->
...
const formattedDate = `${year}-${month}-${day}`;
    ...
    $(document).ready(function() {
        ...
        $("#export").on('click', function() {
            ...
            document.location.href="REP_o2a/excel?date1="+date1+"&date2="+date2;
        });
    ...
    $('#refresh-rep ').click(function() {
        ...
        var t = $("#myreptable").dataTable({
            ...
            info: false,
            bFilter: false,
            ajax: {"url": "REP_o2a/json?date1="+date1+"&date2="+date2, "type": "POST"},
            columns: [
                // {
                //     "data": "barcode_sample",
                //     "orderable": false,
