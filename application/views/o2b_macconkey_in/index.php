<div class="content-wrapper">
    <section class="content">
            ...
            <div class="col-xs-12">
                <div class="box box-black box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">Objective 2B - Macconkey In</h3>
                    </div>
        
        <div class="box-body">
        <div style="padding-bottom: 10px;">
        <button class='btn btn-primary' id='addtombol'><i class="fa fa-wpforms" aria-hidden="true"></i> New Macconkey IN</button>
		...
		<?php echo anchor(site_url('O2b_macconkey_in/excel'), '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export to CSV', 'class="btn btn-success"'); ?></div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header box">
                    ...
                    <h4 class="modal-title" id="modal-title">O2B - Macconkey In</h4>
                </div>
                <form id="formSample"  action= <?php echo site_url('O2b_macconkey_in/save') ?> method="post" class="form-horizontal">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        function load_stype(data1) {
            $.ajax({
                type: "GET",
                url: "O2b_macconkey_in/load_stype?id1="+data1,
                dataType: "json",
        ...
        $('#barcode_sample').on("change", function() {
            ...
            $.ajax({
                type: "GET",
                url: "O2b_macconkey_in/valid_bs?id1="+data1,
                // data:data1,
                dataType: "json",
                success: function(data) {
                    // var barcode = '';
        ...
        $('#bar_macconkey').on("change", function() {
            ...
            $.ajax({
                type: "GET",
                url: "O2b_macconkey_in/valid_bs2?id1="+data1,
                // data:data1,
                dataType: "json",
                success: function(data) {
                    // var barcode = '';
        ...
        table = $("#mytable").DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "O2b_macconkey_in/json", "type": "POST"},
            columns: [
                // {
                //     "data": "barcode_sample",
                //     "orderable": false
        ...
        $('#addtombol').click(function() {
            $('.val1tip').tooltipster('hide');   
            $('#mode').val('insert');
            $('#modal-title').html('<i class="fa fa-wpforms"></i> O2B - New Macconkey - In<span id="my-another-cool-loader"></span>');
        ...
        $('#mytable').on('click', '.btn_edit', function(){
            ...
            $('#mode').val('edit');
            $('#modal-title').html('<i class="fa fa-pencil-square"></i> O2B - Update Macconkey - In<span id="my-another-cool-loader"></span>');
