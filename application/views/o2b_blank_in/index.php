<div class="content-wrapper">
    <section class="content">
            ...
            <div class="col-xs-12">
                <div class="box box-black box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">Objective 2B - Blank - In (Endetec/IDEXX)</h3>
                    </div>
        
        <div class="box-body">
        <div style="padding-bottom: 10px;"'>
        <button class='btn btn-primary' id='addtombol'><i class="fa fa-wpforms" aria-hidden="true"></i> New sample blank </button>
		...
		<?php echo anchor(site_url('O2b_blank_in/excel'), '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export to CSV', 'class="btn btn-success"'); ?></div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header box">
                    ...
                    <h4 class="modal-title" id="modal-title">O2B - Sample blank</h4>
                </div>
                <form id="formSample"  action= <?php echo site_url('O2b_blank_in/save') ?> method="post" class="form-horizontal">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="barcode_endidx" class="col-sm-4 control-label">Barcode endetec/IDEXX</label>
                            <div class="col-sm-8">
                                <input id="barcode_endidx" name="barcode_endidx" type="text" class="form-control" placeholder="Barcode endetec/IDEXX" required>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#barcode_sample').on("change", function() {
            ...
            $.ajax({
                type: "GET",
                url: "O2b_blank_in/valid_bs?id1="+data1,
                data:data1,
                dataType: "json",
        ...
        table = $("#mytable").DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "O2b_blank_in/json", "type": "POST"},
            columns: [
                // {
                //     "data": "barcode_sample",
                //     "orderable": false
        ...
        $('#addtombol').click(function() {
            $('.val1tip').tooltipster('hide');   
            $('#mode').val('insert');
            $('#modal-title').html('<i class="fa fa-wpforms"></i> O2B - New sample blank<span id="my-another-cool-loader"></span>');
