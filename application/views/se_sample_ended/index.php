            ...
            <div class="col-xs-12">
                <div class="box box-black box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">Sample External - Sample Ended</h3>
                    </div>
...
<?php
        ...
        if ($lvl != 7){
            echo "<button class='btn btn-primary' id='addtombol'><i class='fa fa-wpforms' aria-hidden='true'></i> New Sample Ended </button>";
        }
?>
        
		<?php echo anchor(site_url('SE_sample_ended/excel'), '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export to CSV', 'class="btn btn-success"'); ?></div>
    ...
    <div class="modal fade" id="compose-modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="formSample"  action= <?php echo site_url('SE_sample_ended/save') ?> method="post" class="form-horizontal">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="date_ended" class="col-sm-4 control-label">Date ended</label>
                            <div class="col-sm-8">
                                <input id="date_ended" name="date_ended" type="date" class="form-control" placeholder="Date ended" value="<?php echo date("Y-m-d"); ?>">
                            </div>
                            </div>

                        <div class="form-group">
                            <label for="lab_sample_end" class="col-sm-4 control-label">Lab sample end</label>
                            <div class="col-sm-8">
                                <input id="lab_sample_end" name="lab_sample_end" type="text" class="form-control" placeholder="Lab sample end" required>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        //     $.ajax({
        //         type: "GET",
        //         url: "SE_sample_ended/valid_bs?id1="+data1,
        //         data:data1,
        //         dataType: "json",
        ...
        table = $("#mytable").DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "SE_sample_ended/json", "type": "POST"},
            columns: [
                // {
                //     "data": "barcode_sample",
                //     "orderable": false
        ...
        $('#addtombol').click(function() {
            $('.val1tip').tooltipster('hide');   
            $('#mode').val('insert');
            $('#modal-title').html('<i class="fa fa-wpforms"></i> Sample External - New Sample Ended<span id="my-another-cool-loader"></span>');
        ...
        $('#mytable').on('click', '.btn_edit', function(){
            ...
            $('#mode').val('edit');
            $('#modal-title').html('<i class="fa fa-pencil-square"></i> Sample External - Update Sample Ended<span id="my-another-cool-loader"></span>');
            $('#barcode_sample').attr('readonly', true);
            $('#barcode_sample').val(data.barcode_sample);
            $('#date_ended').val(data.date_ended);
            $('#lab_sample_end').val(data.lab_sample_end);
