...
class SE_sample_analysis_model extends CI_Model
{

    public $table = 'se_analysis';
    ...
    // datatables
    function json() {
        $this->datatables->select('barcode_sample, date_analysis, analysis, person, comments');
        $this->datatables->from('se_analysis');
        ...
        if ($lvl == 7){
            ...
            $this->datatables->add_column('action', '<button type="button" class="btn_edit btn btn-info btn-sm" aria-hidden="true"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Update</button>'." 
                ".anchor(site_url('SE_sample_analysis/delete/$1'),'<i class="fa fa-trash-o" aria-hidden="true"></i>','class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Confirm deleting sample : $1 ?\')"'), 'barcode_sample');
        }
    ...
    function get_all()
    {
        ...
        return $this->db->get('se_analysis')->result();
    }
