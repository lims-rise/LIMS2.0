...
class O2b_macconkey_in_model extends CI_Model
{

    public $table = 'obj2b_mac1';
    ...
    // datatables
    function json() {
        $this->datatables->select('obj2b_mac1.bar_macconkey, obj2b_mac1.barcode_sample, obj2b_mac1.barcode_falcon2, 
        obj2b_mac1.date_process, obj2b_mac1.time_process, ref_person.initial, obj2b_mac1.volume, obj2b_mac1.comments, obj2b_mac1.lab, obj2b_mac1.flag, obj2b_mac1.id_person');
        $this->datatables->from('obj2b_mac1');
    ...
    function load_stype($id){
      ...
      function validate1($id){
        ...
        SELECT sampletype FROM
        (
        SELECT a.barcode_sample AS "barcode_sample", b.sampletype AS "sampletype" FROM obj2b_receipt a
          LEFT JOIN ref_sampletype b ON a.id_type2b=b.id_sampletype
          WHERE a.id_type2b not IN (7,9)
        ...
        WHERE barcode_sample = "'.$id.'" 
        AND barcode_sample NOT IN (SELECT barcode_sample FROM obj2b_mac1)    
        ');        
        $response = $q->result_array();
        return $response;
        // return $this->db->get('ref_location_80')->row();
      ...
      function validate2($id){
        $q = $this->db->query('
        SELECT bar_macconkey FROM obj2b_mac1
