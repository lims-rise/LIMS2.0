...
class DNA_concentration_model extends CI_Model
{

    public $table = 'dna_concentration';
    ...
    {
        $q = $this->db->query('
        SELECT a.barcode_dna, a.date_concentration, c.initial, b.sampletype, a.dna_concentration, a.comments
