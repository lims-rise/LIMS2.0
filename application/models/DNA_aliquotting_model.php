...
class DNA_aliquotting_model extends CI_Model
{
    ...
    function json() {
        ...
        if ($lvl == 7){
            ...
            $this->datatables->add_column('action', anchor(site_url('dna_aliquotting/read/$1'),'<i class="fa fa-eye" aria-hidden="true"></i>', array('class' => 'btn btn-warning btn-sm'))." 
                    ...
                    ".'<button type="button" class="btn_delete btn btn-danger btn-sm" data-id="$1" aria-hidden="true"><i class="fa fa-trash-o" aria-hidden="true"></i></button>', 'id_dna');
        }
