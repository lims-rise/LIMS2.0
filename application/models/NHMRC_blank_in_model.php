...
class NHMRC_blank_in_model extends CI_Model
{

    public $table = 'nhmrc_blanks';
    ...
    // datatables
    function json() {
        $this->datatables->select('barcode_sample, date_conduct, time_incubation, blank_type, barcode_endidx, volume, dilution, comments, lab, flag');
        $this->datatables->from('nhmrc_blanks');
        ...
        if ($lvl == 7){
            ...
            $this->datatables->add_column('action', '<button type="button" class="btn_edit btn btn-info btn-sm" aria-hidden="true"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Update</button>'." 
                ".anchor(site_url('NHMRC_blank_in/delete/$1'),'<i class="fa fa-trash-o" aria-hidden="true"></i>','class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Confirm deleting sample : $1 ?\')"'), 'barcode_sample');
        }
    ...
    function get_all()
    {
        ...
        return $this->db->get('nhmrc_blanks')->result();
    }
