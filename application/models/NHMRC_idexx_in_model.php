...
class NHMRC_idexx_in_model extends CI_Model
{

    public $table = 'nhmrc_idexx1';
    ...
    function json() {
        ...
        $this->datatables->from('nhmrc_idexx1');
        ...
        if ($lvl == 7){
            ...
            $this->datatables->add_column('action', '<button type="button" class="btn_edit btn btn-info btn-sm" aria-hidden="true"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Update</button>'." 
                ".anchor(site_url('NHMRC_idexx_in/delete/$1'),'<i class="fa fa-trash-o" aria-hidden="true"></i>','class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Confirm deleting sample : $1 ?\')"'), 'barcode_sample');
        }
    ...
    function get_all()
    {
        ...
        return $this->db->get('nhmrc_idexx1')->result();
    }
    ...
    //   }
      ...
      function validate1($id){
        ...
        AND barcode_sample NOT IN (SELECT barcode_sample FROM nhmrc_idexx1)        
