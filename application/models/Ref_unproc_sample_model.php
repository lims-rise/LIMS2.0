...
class Ref_unproc_sample_model extends CI_Model
{

    public $table = 'unproc_sample';
    ...
    // datatables
    function json() {
        $this->datatables->select('barcode_sample, date_entry, time_entry, comments');
        $this->datatables->from('unproc_sample');
        ...
        $this->datatables->add_column('action', '<button type="button" class="btn_edit btn btn-info btn-sm" aria-hidden="true"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Update</button>'." 
                ".anchor(site_url('Ref_unproc_sample/delete/$1'),'<i class="fa fa-trash-o" aria-hidden="true"></i>','class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Confirm deleting sample : $1 ?\')"'), 'barcode_sample');
    ...
    function get_all()
    {
        ...
        return $this->db->get('unproc_sample')->result();
    }
