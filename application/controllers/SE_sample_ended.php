...
class SE_sample_ended extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        is_login();
        $this->load->model('SE_sample_ended_model');
    ...
    {
        // $this->load->model('SE_sample_ended_model');
        // $data['person'] = $this->SE_sample_ended_model->getLabtech();
        // $data['type'] = $this->SE_sample_ended_model->getSampleType();
        // $this->template->load('template','SE_sample_ended/index', $data);
        $this->template->load('template','SE_sample_ended/index');
    } 
    
    public function json() {
        header('Content-Type: application/json');
        echo $this->SE_sample_ended_model->json();
    }
    ...
    public function save() 
    {
        ...
        if ($mode=="insert"){
            ...
            $this->SE_sample_ended_model->insert($data);
            ...
            $this->SE_sample_ended_model->update($id, $data);
            $this->session->set_flashdata('message', 'Create Record Success');    
        }

        redirect(site_url("SE_sample_ended"));
    }

    public function delete($id) 
    {
        $row = $this->SE_sample_ended_model->get_by_id($id);
        ...
        if ($row) {
            // $this->SE_sample_ended_model->delete($id);
            $this->SE_sample_ended_model->update($id, $data);
    ...
    public function valid_bs() 
    {
        ...
        // echo $id;
        $data = $this->SE_sample_ended_model->validate1($id);
    ...
    public function excel()
    {
        ...
        $sheet->setCellValue('B1', "Date_ended"); 
        $sheet->setCellValue('C1', "Lab_sample_end");
        $sheet->setCellValue('D1', "Comments");
        // $sheet->getStyle('A1:H1')->getFont()->setBold(true); // Set bold kolom A1

        // Panggil function view yang ada di SiswaModel untuk menampilkan semua data siswanya
        $rdeliver = $this->SE_sample_ended_model->get_all();
    ...
    $datenow=date("Ymd");
    $fileName = 'SE_Sample_Ended_'.$datenow.'.csv';
...
/* End of file SE_sample_ended.php */
/* Location: ./application/controllers/SE_sample_ended.php */
