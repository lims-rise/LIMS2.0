...
class O2b_blank_in extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        is_login();
        $this->load->model('O2b_blank_in_model');
    ...
    {
        // $this->load->model('O2b_blank_in_model');
        // $data['person'] = $this->O2b_blank_in_model->getLabtech();
        // $data['type'] = $this->O2b_blank_in_model->getSampleType();
        $this->template->load('template','O2b_blank_in/index');
    } 
    
    public function json() {
        header('Content-Type: application/json');
        echo $this->O2b_blank_in_model->json();
    }
    ...
    public function save() 
    {
        ...
        if ($mode=="insert"){
            ...
            $this->O2b_blank_in_model->insert($data);
            ...
            $this->O2b_blank_in_model->update($id, $data);
            $this->session->set_flashdata('message', 'Create Record Success');    
        }

        redirect(site_url("O2b_blank_in"));
    }

    public function delete($id) 
    {
        $row = $this->O2b_blank_in_model->get_by_id($id);
        ...
        if ($row) {
            // $this->O2b_blank_in_model->delete($id);
            $this->O2b_blank_in_model->update($id, $data);
    ...
    public function valid_bs() 
    {
        ...
        // echo $id;
        $data = $this->O2b_blank_in_model->validate1($id);
    ...
    public function excel()
    {
        ...
        $rdeliver = $this->O2b_blank_in_model->get_all();
...
/* End of file O2b_blank_in.php */
/* Location: ./application/controllers/O2b_blank_in.php */
