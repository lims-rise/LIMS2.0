...
class SE_sample_sent_other extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        is_login();
        $this->load->model('SE_sample_sent_other_model');
    ...
    {
        // $this->load->model('SE_sample_sent_other_model');
        // $data['person'] = $this->SE_sample_sent_other_model->getLabtech();
        // $data['type'] = $this->SE_sample_sent_other_model->getSampleType();
        // $this->template->load('template','SE_sample_sent_other/index', $data);
        $this->template->load('template','SE_sample_sent_other/index');
    } 
    
    public function json() {
        header('Content-Type: application/json');
        echo $this->SE_sample_sent_other_model->json();
    }
    ...
    public function save() 
    {
        ...
        if ($mode=="insert"){
            ...
            $this->SE_sample_sent_other_model->insert($data);
            ...
            $this->SE_sample_sent_other_model->update($id, $data);
            $this->session->set_flashdata('message', 'Create Record Success');    
        }

        redirect(site_url("SE_sample_sent_other"));
    }

    public function delete($id) 
    {
        $row = $this->SE_sample_sent_other_model->get_by_id($id);
        ...
        if ($row) {
            // $this->SE_sample_sent_other_model->delete($id);
            $this->SE_sample_sent_other_model->update($id, $data);
    ...
    public function valid_bs() 
    {
        ...
        // echo $id;
        $data = $this->SE_sample_sent_other_model->validate1($id);
    ...
    public function excel()
    {
        ...
        $rdeliver = $this->SE_sample_sent_other_model->get_all();
    ...
    $datenow=date("Ymd");
    $fileName = 'SE_Sent_Other_Lab_'.$datenow.'.csv';
...
/* End of file SE_sample_sent_other.php */
/* Location: ./application/controllers/SE_sample_sent_other.php */
