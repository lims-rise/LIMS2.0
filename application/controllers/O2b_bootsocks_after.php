...
class O2b_bootsocks_after extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        is_login();
        $this->load->model('O2b_bootsocks_after_model');
    ...
    {
        // $data['person'] = $this->O2b_bootsocks_after_model->getLabtech();
        // $data['staff'] = $this->O2b_bootsocks_after_model->getAllstaff();
        $this->template->load('template','O2b_bootsocks_after/index');
    } 
    
    public function json() {
        header('Content-Type: application/json');
        echo $this->O2b_bootsocks_after_model->json();
    }

    // public function subjson() {
    //     $id=$this->input->get('id');
    //     header('Content-Type: application/json');
    //     echo $this->O2b_bootsocks_after_model->subjson($id);
    // }
    ...
    public function save() 
    {
        ...
        if ($mode=="insert"){
            ...
            $this->O2b_bootsocks_after_model->insert($data);
            ...
            $this->O2b_bootsocks_after_model->update($id, $data);
            $this->session->set_flashdata('message', 'Create Record Success');    
        }

        redirect(site_url("O2b_bootsocks_after"));
    }
    ...
    //         $this->O2b_bootsocks_after_model->insert_det($data);
    //         $this->session->set_flashdata('message', 'Create Record Success');    
    //     }
    ...
    //         $this->O2b_bootsocks_after_model->update_det($id, $data);
    //         $this->session->set_flashdata('message', 'Create Record Success');    
    //     }
    ...
    {
        $row = $this->O2b_bootsocks_after_model->get_by_id($id);
        // $id_rec = $this->O2b_bootsocks_after_model->get_by_id_rec($id);
    ...
    // {
    //     $row = $this->O2b_bootsocks_after_model->get_by_id_detail($id);
    ...
    public function valid_bs() 
    {
        ...
        $data = $this->O2b_bootsocks_after_model->validate1($id, $type);
    ...
    public function excel()
    {
        ...
        $rdeliver = $this->O2b_bootsocks_after_model->get_all();
...
/* End of file O2b_bootsocks_after.php */
/* Location: ./application/controllers/O2b_bootsocks_after.php */
