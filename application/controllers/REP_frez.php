...
class REP_frez extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        is_login();
        $this->load->model('REP_frez_model');
    ...
    {
        $this->template->load('template','REP_frez/index');
    } 

    // public function index2()
    // {
    //     $this->template->load('template','REP_frez/index2');
    // } 
    ...
    public function json() {
        ...
        echo $this->REP_frez_model->json($date1,$date2);
    }
    ...
    public function excel()
    {
        ...
        // $rdeliver = $this->REP_frez_model->get_all($date1, $date2);
        ...
        // // Proses file excel
        // header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
        // header('Content-Disposition: attachment; filename="REP_frezs.xlsx"'); // Set nama file excel nya
        // header('Cache-Control: max-age=0');
