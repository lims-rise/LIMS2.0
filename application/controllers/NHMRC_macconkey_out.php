...
class NHMRC_macconkey_out extends CI_Controller
{
    ...
    public function save() 
    {
        ...
        $id_loc1 = $this->NHMRC_macconkey_out_model->get_freez($f1,$s1,$r1,$d1);
        $id_loc2 = $this->NHMRC_macconkey_out_model->get_freez($f2,$s2,$r2,$d2);
        $dt = new DateTime();
        ...
        if ($mode=="insert"){
            ...
            $this->NHMRC_macconkey_out_model->insert_freezer($data);    
            $id_freezer1 = $this->NHMRC_macconkey_out_model->get_id_freezer($this->input->post('bar_macsweep1',TRUE));
            ...
            $this->NHMRC_macconkey_out_model->insert_freezer($data);                 
            $id_freezer2 = $this->NHMRC_macconkey_out_model->get_id_freezer($this->input->post('bar_macsweep2',TRUE));
            ...
            $this->NHMRC_macconkey_out_model->update_freezer($id_f1, $data);       
            ...
            $this->NHMRC_macconkey_out_model->update_freezer($id_f2, $data);                 
        }
