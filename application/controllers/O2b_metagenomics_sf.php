...
class O2b_metagenomics_sf extends CI_Controller
{
    ...
    public function save() 
    {
        ...
        if ($mode=="insert"){
            ...
            $id_freezer1 = $this->O2b_metagenomics_sf_model->get_id_freezer($this->input->post('barcode_dna1',TRUE));
            ...
            $this->O2b_metagenomics_sf_model->insert_freezer($data);     
            $id_freezer2 = $this->O2b_metagenomics_sf_model->get_id_freezer($this->input->post('barcode_dna2',TRUE));
            ...
            $this->O2b_metagenomics_sf_model->update_freezer($id_f1, $data);       
            ...
            $this->O2b_metagenomics_sf_model->update_freezer($id_f2, $data);      
        }
    ...
    {
        $id = $this->input->get('id1');
        $data = $this->O2b_metagenomics_sf_model->validatedna($id);
        header('Content-Type: application/json');
        echo json_encode($data);
    }
