...
class O2b_endetec_in extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        is_login();
        $this->load->model('O2b_endetec_in_model');
    ...
    {
        // $this->load->model('O2b_endetec_in_model');
        // $data['person'] = $this->O2b_endetec_in_model->getLabtech();
        // $data['type'] = $this->O2b_endetec_in_model->getSampleType();
        $this->template->load('template','O2b_endetec_in/index');
    } 
    
    public function json() {
        header('Content-Type: application/json');
        echo $this->O2b_endetec_in_model->json();
    }
    ...
    public function save() 
    {
        ...
        if ($mode=="insert"){
            ...
            $this->O2b_endetec_in_model->insert($data);
            ...
            $this->O2b_endetec_in_model->update($id, $data);
            $this->session->set_flashdata('message', 'Create Record Success');    
        }

        redirect(site_url("O2b_endetec_in"));
    }

    public function delete($id) 
    {
        $row = $this->O2b_endetec_in_model->get_by_id($id);
        ...
        if ($row) {
            // $this->O2b_endetec_in_model->delete($id);
            $this->O2b_endetec_in_model->update($id, $data);
    ...
    public function valid_bs() 
    {
        ...
        $data = $this->O2b_endetec_in_model->validate1($id);
        header('Content-Type: application/json');
    ...
    public function valid_bs2() 
    {
        ...
        $data = $this->O2b_endetec_in_model->validate2($id, $id2);
        header('Content-Type: application/json');
        echo json_encode($data);
    }
    ...
    public function excel()
    {
        ...
        $sheet->setCellValue('D1', "Barcode_endetec");
        ...
        $rdeliver = $this->O2b_endetec_in_model->get_all();
    ...
    $datenow=date("Ymd");
    $fileName = 'O2B_Endetec_IN_(Water)_'.$datenow.'.csv';
...
/* End of file O2b_endetec_in.php */
/* Location: ./application/controllers/O2b_endetec_in.php */
