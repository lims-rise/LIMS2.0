...
class REP_o2b extends CI_Controller
{
    ...
    public function excel()
    {
        ...
        $datenow=date("Ymd");
            ...
            $sheet->setCellValue('AV1', "mois72_barcode_foil");
            $sheet->setCellValue('AW1', "mois72_dry_weight72");
            $sheet->setCellValue('AX1', "mois72_comments");
            $sheet->setCellValue('AY1', "stomacher_date_conduct");
            $sheet->setCellValue('AZ1', "stomacher_barcode_bootsocks1");
            $sheet->setCellValue('BA1', "stomacher_elution_number_Micro1");
            $sheet->setCellValue('BB1', "stomacher_elution_Micro1");
            $sheet->setCellValue('BC1', "stomacher_barcode_falcon_Micro1");
            $sheet->setCellValue('BD1', "stomacher_volume_Micro1");
            $sheet->setCellValue('BE1', "stomacher_elution_number_Micro2");
            $sheet->setCellValue('BF1', "stomacher_elution_Micro2");
            $sheet->setCellValue('BG1', "stomacher_barcode_falcon_Micro2");
            $sheet->setCellValue('BH1', "stomacher_volume_Micro2");
            $sheet->setCellValue('BI1', "stomacher_barcode_bootsocks2");
            $sheet->setCellValue('BJ1', "stomacher_elution_number_Moisture1");
            $sheet->setCellValue('BK1', "stomacher_elution_Moisture1");
            $sheet->setCellValue('BL1', "stomacher_barcode_falcon_Moisture1");
            $sheet->setCellValue('BM1', "stomacher_volume_Moisture1");
            $sheet->setCellValue('BN1', "stomacher_elution_number_Moisture2");
            $sheet->setCellValue('BO1', "stomacher_elution_Moisture2");
            $sheet->setCellValue('BP1', "stomacher_barcode_falcon_Moisture2");
            $sheet->setCellValue('BQ1', "stomacher_volume_Moisture2");
            $sheet->setCellValue('BR1', "old_stom_endet_barcode_endetec");
            $sheet->setCellValue('BS1', "old_stom_endet_barcode_falcon1");
            $sheet->setCellValue('BT1', "old_stom_endet_volume_falcon1");
            $sheet->setCellValue('BU1', "old_stom_endet_barcode_falcon2");
            $sheet->setCellValue('BV1', "old_stom_endet_volume_falcon2");
            $sheet->setCellValue('BW1', "old_stom_endet_dilution");
            $sheet->setCellValue('BX1', "old_stom_endet_time_incu_start");
            $sheet->setCellValue('BY1', "old_stom_endet_comments");
            $sheet->setCellValue('BZ1', "old_stom_idexx_barcode_colilert");
            $sheet->setCellValue('CA1', "old_stom_idexx_barcode_falcon1");
            $sheet->setCellValue('CB1', "old_stom_idexx_volume_falcon1");
            $sheet->setCellValue('CC1', "old_stom_idexx_barcode_falcon2");
            $sheet->setCellValue('CD1', "old_stom_idexx_volume_falcon2");
            $sheet->setCellValue('CE1', "old_stom_idexx_dilution");
            $sheet->setCellValue('CF1', "old_stom_idexx_time_incu_start");
            $sheet->setCellValue('CG1', "old_stom_idexx_comments");
            $sheet->setCellValue('CH1', "stom_endet_barcode_endetec");
            $sheet->setCellValue('CI1', "stom_endet_barcode_falcon1");
            $sheet->setCellValue('CJ1', "stom_endet_volume_falcon1");
            $sheet->setCellValue('CK1', "stom_endet_barcode_falcon2");
            $sheet->setCellValue('CL1', "stom_endet_volume_falcon2");
            $sheet->setCellValue('CM1', "stom_endet_dilution");
            $sheet->setCellValue('CN1', "stom_endet_time_incu_start");
            $sheet->setCellValue('CO1', "stom_endet_comments");
            $sheet->setCellValue('CP1', "stom_idexx_barcode_colilert");
            $sheet->setCellValue('CQ1', "stom_idexx_barcode_falcon1");
            $sheet->setCellValue('CR1', "stom_idexx_volume_falcon1");
            $sheet->setCellValue('CS1', "stom_idexx_barcode_falcon2");
            $sheet->setCellValue('CT1', "stom_idexx_volume_falcon2");
            $sheet->setCellValue('CU1', "stom_idexx_dilution");
            $sheet->setCellValue('CV1', "stom_idexx_time_incu_start");
            $sheet->setCellValue('CW1', "stom_idexx_comments");
            $sheet->setCellValue('CX1', "endet_out(b)_date_conduct");
            $sheet->setCellValue('CY1', "endet_out(b)_barcode_endetec");
            $sheet->setCellValue('CZ1', "endet_out(b)_time_ecoli");
            ...
            foreach($rdeliver as $data){ 
                ...
                $sheet->setCellValue('AV'.$numrow, $this->cleanEnter($data->mois72_barcode_foil));
                $sheet->setCellValue('AW'.$numrow, $this->cleanEnter($data->mois72_dry_weight72));
                $sheet->setCellValue('AX'.$numrow, $this->cleanEnter($data->mois72_comments));
                $sheet->setCellValue('AY'.$numrow, $this->cleanEnter($data->stomacher_date_conduct));
                $sheet->setCellValue('AZ'.$numrow, $this->cleanEnter($data->stomacher_barcode_bootsocks1));
                $sheet->setCellValue('BA'.$numrow, $this->cleanEnter($data->stomacher_elution_number_Micro1));
                $sheet->setCellValue('BB'.$numrow, $this->cleanEnter($data->stomacher_elution_Micro1));
                $sheet->setCellValue('BC'.$numrow, $this->cleanEnter($data->stomacher_barcode_falcon_Micro1));
                $sheet->setCellValue('BD'.$numrow, $this->cleanEnter($data->stomacher_volume_Micro1));
                $sheet->setCellValue('BE'.$numrow, $this->cleanEnter($data->stomacher_elution_number_Micro2));
                $sheet->setCellValue('BF'.$numrow, $this->cleanEnter($data->stomacher_elution_Micro2));
                $sheet->setCellValue('BG'.$numrow, $this->cleanEnter($data->stomacher_barcode_falcon_Micro2));
                $sheet->setCellValue('BH'.$numrow, $this->cleanEnter($data->stomacher_volume_Micro2));        
                $sheet->setCellValue('BI'.$numrow, $this->cleanEnter($data->stomacher_barcode_bootsocks2));
                $sheet->setCellValue('BJ'.$numrow, $this->cleanEnter($data->stomacher_elution_number_Moisture1));
                $sheet->setCellValue('BK'.$numrow, $this->cleanEnter($data->stomacher_elution_Moisture1));
                $sheet->setCellValue('BL'.$numrow, $this->cleanEnter($data->stomacher_barcode_falcon_Moisture1));
                $sheet->setCellValue('BM'.$numrow, $this->cleanEnter($data->stomacher_volume_Moisture1));
                $sheet->setCellValue('BN'.$numrow, $this->cleanEnter($data->stomacher_elution_number_Moisture2));
                $sheet->setCellValue('BO'.$numrow, $this->cleanEnter($data->stomacher_elution_Moisture2));
                $sheet->setCellValue('BP'.$numrow, $this->cleanEnter($data->stomacher_barcode_falcon_Moisture2));
                $sheet->setCellValue('BQ'.$numrow, $this->cleanEnter($data->stomacher_volume_Moisture2));     
                $sheet->setCellValue('BR'.$numrow, $this->cleanEnter($data->old_stom_endet_barcode_endetec));
                $sheet->setCellValue('BS'.$numrow, $this->cleanEnter($data->old_stom_endet_barcode_falcon1));
                $sheet->setCellValue('BT'.$numrow, $this->cleanEnter($data->old_stom_endet_volume_falcon1));
                $sheet->setCellValue('BU'.$numrow, $this->cleanEnter($data->old_stom_endet_barcode_falcon2));
                $sheet->setCellValue('BV'.$numrow, $this->cleanEnter($data->old_stom_endet_volume_falcon2));
                $sheet->setCellValue('BW'.$numrow, $this->cleanEnter($data->old_stom_endet_dilution));
                $sheet->setCellValue('BX'.$numrow, $this->cleanEnter($data->old_stom_endet_time_incu_start));
                $sheet->setCellValue('BY'.$numrow, $this->cleanEnter($data->old_stom_endet_comments));
                $sheet->setCellValue('BZ'.$numrow, $this->cleanEnter($data->old_stom_idexx_barcode_colilert));
                $sheet->setCellValue('CA'.$numrow, $this->cleanEnter($data->old_stom_idexx_barcode_falcon1));
                $sheet->setCellValue('CB'.$numrow, $this->cleanEnter($data->old_stom_idexx_volume_falcon1));
                $sheet->setCellValue('CC'.$numrow, $this->cleanEnter($data->old_stom_idexx_barcode_falcon2));
                $sheet->setCellValue('CD'.$numrow, $this->cleanEnter($data->old_stom_idexx_volume_falcon2));
                $sheet->setCellValue('CE'.$numrow, $this->cleanEnter($data->old_stom_idexx_dilution));
                $sheet->setCellValue('CF'.$numrow, $this->cleanEnter($data->old_stom_idexx_time_incu_start));
                $sheet->setCellValue('CG'.$numrow, $this->cleanEnter($data->old_stom_idexx_comments));
                $sheet->setCellValue('CH'.$numrow, $this->cleanEnter($data->stom_endet_barcode_endetec));
                $sheet->setCellValue('CI'.$numrow, $this->cleanEnter($data->stom_endet_barcode_falcon1));
                $sheet->setCellValue('CJ'.$numrow, $this->cleanEnter($data->stom_endet_volume_falcon1));
                $sheet->setCellValue('CK'.$numrow, $this->cleanEnter($data->stom_endet_barcode_falcon2));
                $sheet->setCellValue('CL'.$numrow, $this->cleanEnter($data->stom_endet_volume_falcon2));
                $sheet->setCellValue('CM'.$numrow, $this->cleanEnter($data->stom_endet_dilution));
                $sheet->setCellValue('CN'.$numrow, $this->cleanEnter($data->stom_endet_time_incu_start));
                $sheet->setCellValue('CO'.$numrow, $this->cleanEnter($data->stom_endet_comments));
                $sheet->setCellValue('CP'.$numrow, $this->cleanEnter($data->stom_idexx_barcode_colilert));
                $sheet->setCellValue('CQ'.$numrow, $this->cleanEnter($data->stom_idexx_barcode_falcon1));
                $sheet->setCellValue('CR'.$numrow, $this->cleanEnter($data->stom_idexx_volume_falcon1));
                $sheet->setCellValue('CS'.$numrow, $this->cleanEnter($data->stom_idexx_barcode_falcon2));
                $sheet->setCellValue('CT'.$numrow, $this->cleanEnter($data->stom_idexx_volume_falcon2));
                $sheet->setCellValue('CU'.$numrow, $this->cleanEnter($data->stom_idexx_dilution));
                $sheet->setCellValue('CV'.$numrow, $this->cleanEnter($data->stom_idexx_time_incu_start));
                $sheet->setCellValue('CW'.$numrow, $this->cleanEnter($data->stom_idexx_comments));
                $sheet->setCellValue('CX'.$numrow, $this->cleanEnter($data->endet_out_b_date_conduct));
                $sheet->setCellValue('CY'.$numrow, $this->cleanEnter($data->endet_out_b_barcode_endetec));
                $sheet->setCellValue('CZ'.$numrow, $this->cleanEnter($data->endet_out_b_time_ecoli));
        ...
        $fileName = 'O2B_bootsock_report_'.$datenow.'.csv';        
            ...
            $sheet->setCellValue('AB1', "mois72_date_moisture");
            $sheet->setCellValue('AC1', "mois72_barcode_foil");
            $sheet->setCellValue('AD1', "mois72_dry_weight72");
            $sheet->setCellValue('AE1', "mois72_comments");
            $sheet->setCellValue('AF1', "sedi_endet_barcode_endetec");
            $sheet->setCellValue('AG1', "sedi_endet_volume_falcon");
            $sheet->setCellValue('AH1', "sedi_endet_dilution");
            $sheet->setCellValue('AI1', "sedi_endet_time_incu_start");
            $sheet->setCellValue('AJ1', "sedi_endet_comments");
            $sheet->setCellValue('AK1', "endet_out(s)_date_conduct");
            $sheet->setCellValue('AL1', "endet_out(s)_barcode_endetec");
            $sheet->setCellValue('AM1', "endet_out(s)_time_ecoli");
            $sheet->setCellValue('AN1', "endet_out(s)_volume_ecoli");
            $sheet->setCellValue('AO1', "endet_out(s)_total_coliforms");
            $sheet->setCellValue('AP1', "endet_out(s)_comments");
            $sheet->setCellValue('AQ1', "sedi_idexx_barcode_colilert");
            $sheet->setCellValue('AR1', "sedi_idexx_volume");
            $sheet->setCellValue('AS1', "sedi_idexx_dilution");
            $sheet->setCellValue('AT1', "sedi_idexx_time_incubation");
            $sheet->setCellValue('AU1', "sedi_idexx_comments");
            $sheet->setCellValue('AV1', "sedi_idexx_barcode_colilert2");
            $sheet->setCellValue('AW1', "sedi_idexx_volume2");
            $sheet->setCellValue('AX1', "sedi_idexx_dilution2");
            $sheet->setCellValue('AY1', "sedi_idexx_time_incubation2");
            $sheet->setCellValue('AZ1', "sedi_idexx_comments2");
            $sheet->setCellValue('BA1', "idexx_out_date_conduct");
            $sheet->setCellValue('BB1', "idexx_out_timeout_incubation");
            $sheet->setCellValue('BC1', "idexx_out_time_minutes");
            $sheet->setCellValue('BD1', "idexx_out_ecoli_largewells");
            $sheet->setCellValue('BE1', "idexx_out_ecoli_smallwells");
            $sheet->setCellValue('BF1', "idexx_out_ecoli_mpn");
            $sheet->setCellValue('BG1', "idexx_out_coliforms_largewells");
            $sheet->setCellValue('BH1', "idexx_out_coliforms_smallwells");
            $sheet->setCellValue('BI1', "idexx_out_coliforms_mpn");
            $sheet->setCellValue('BJ1', "idexx_out_comments");
            $sheet->setCellValue('BK1', "idexx_out_date_conduct2");
            $sheet->setCellValue('BL1', "idexx_out_timeout_incubation2");
            $sheet->setCellValue('BM1', "idexx_out_time_minutes2");
            $sheet->setCellValue('BN1', "idexx_out_ecoli_largewells2");
            $sheet->setCellValue('BO1', "idexx_out_ecoli_smallwells2");
            $sheet->setCellValue('BP1', "idexx_out_ecoli_mpn2");
            $sheet->setCellValue('BQ1', "idexx_out_coliforms_largewells2");
            $sheet->setCellValue('BR1', "idexx_out_coliforms_smallwells2");
            $sheet->setCellValue('BS1', "idexx_out_coliforms_mpn2");
            $sheet->setCellValue('BT1', "idexx_out_comments2");
            $sheet->setCellValue('BU1', "metagenomics_date_conduct");
            $sheet->setCellValue('BV1', "metagenomics_barcode_sample");
            $sheet->setCellValue('BW1', "metagenomics_barcode_dna1");
            $sheet->setCellValue('BX1', "metagenomics_weight_sub1");
            $sheet->setCellValue('BY1', "metagenomics_barcode_storage1");
            $sheet->setCellValue('BZ1', "metagenomics_position_tube1");
            $sheet->setCellValue('CA1', "metagenomics_location1");
            $sheet->setCellValue('CB1', "metagenomics_barcode_dna2");
            $sheet->setCellValue('CC1', "metagenomics_weight_sub2");
            $sheet->setCellValue('CD1', "metagenomics_barcode_storage2");
            $sheet->setCellValue('CE1', "metagenomics_position_tube2");
            $sheet->setCellValue('CF1', "metagenomics_location2");
            $sheet->setCellValue('CG1', "metagenomics_comments");
            $sheet->setCellValue('CH1', "mac1_barcode_macconkey");
            $sheet->setCellValue('CI1', "mac1_date_process");
            $sheet->setCellValue('CJ1', "mac1_time_process");
            $sheet->setCellValue('CK1', "mac1_volume");
            $sheet->setCellValue('CL1', "mac1_comments");
            $sheet->setCellValue('CM1', "mac2_date_process");
            ...
            foreach($rdeliver as $data){ 
                ...
                $sheet->setCellValue('AB'.$numrow, $this->cleanEnter($data->mois72_date_moisture));
                $sheet->setCellValue('AC'.$numrow, $this->cleanEnter($data->mois72_barcode_foil));
                $sheet->setCellValue('AD'.$numrow, $this->cleanEnter($data->mois72_dry_weight72));
                $sheet->setCellValue('AE'.$numrow, $this->cleanEnter($data->mois72_comments));
                $sheet->setCellValue('AF'.$numrow, $this->cleanEnter($data->sedi_endet_barcode_endetec));
                $sheet->setCellValue('AG'.$numrow, $this->cleanEnter($data->sedi_endet_volume_falcon));
                $sheet->setCellValue('AH'.$numrow, $this->cleanEnter($data->sedi_endet_dilution));
                $sheet->setCellValue('AI'.$numrow, $this->cleanEnter($data->sedi_endet_time_incu_start));
                $sheet->setCellValue('AJ'.$numrow, $this->cleanEnter($data->sedi_endet_comments));
                $sheet->setCellValue('AK'.$numrow, $this->cleanEnter($data->endet_out_s_date_conduct));
                $sheet->setCellValue('AL'.$numrow, $this->cleanEnter($data->endet_out_s_barcode_endetec));
                $sheet->setCellValue('AM'.$numrow, $this->cleanEnter($data->endet_out_s_time_ecoli));
                $sheet->setCellValue('AN'.$numrow, $this->cleanEnter($data->endet_out_s_volume_ecoli));
                $sheet->setCellValue('AO'.$numrow, $this->cleanEnter($data->endet_out_s_total_coliforms));
                $sheet->setCellValue('AP'.$numrow, $this->cleanEnter($data->endet_out_s_comments));
                $sheet->setCellValue('AQ'.$numrow, $this->cleanEnter($data->sedi_idexx_barcode_colilert));
                $sheet->setCellValue('AR'.$numrow, $this->cleanEnter($data->sedi_idexx_volume));
                $sheet->setCellValue('AS'.$numrow, $this->cleanEnter($data->sedi_idexx_dilution));
                $sheet->setCellValue('AT'.$numrow, $this->cleanEnter($data->sedi_idexx_time_incubation));
                $sheet->setCellValue('AU'.$numrow, $this->cleanEnter($data->sedi_idexx_comments));
                $sheet->setCellValue('AV'.$numrow, $this->cleanEnter($data->sedi_idexx_barcode_colilert2));
                $sheet->setCellValue('AW'.$numrow, $this->cleanEnter($data->sedi_idexx_volume2));
                $sheet->setCellValue('AX'.$numrow, $this->cleanEnter($data->sedi_idexx_dilution2));
                $sheet->setCellValue('AY'.$numrow, $this->cleanEnter($data->sedi_idexx_time_incubation2));
                $sheet->setCellValue('AZ'.$numrow, $this->cleanEnter($data->sedi_idexx_comments2));
                $sheet->setCellValue('BA'.$numrow, $this->cleanEnter($data->idexx_out_date_conduct));
                $sheet->setCellValue('BB'.$numrow, $this->cleanEnter($data->idexx_out_timeout_incubation));
                $sheet->setCellValue('BC'.$numrow, $this->cleanEnter($data->idexx_out_time_minutes));
                $sheet->setCellValue('BD'.$numrow, $this->cleanEnter($data->idexx_out_ecoli_largewells));
                $sheet->setCellValue('BE'.$numrow, $this->cleanEnter($data->idexx_out_ecoli_smallwells));
                $sheet->setCellValue('BF'.$numrow, $this->cleanEnter($data->idexx_out_ecoli_mpn));
                $sheet->setCellValue('BG'.$numrow, $this->cleanEnter($data->idexx_out_coliforms_largewells));
                $sheet->setCellValue('BH'.$numrow, $this->cleanEnter($data->idexx_out_coliforms_smallwells));
                $sheet->setCellValue('BI'.$numrow, $this->cleanEnter($data->idexx_out_coliforms_mpn));
                $sheet->setCellValue('BJ'.$numrow, $this->cleanEnter($data->idexx_out_comments));
                $sheet->setCellValue('BK'.$numrow, $this->cleanEnter($data->idexx_out_date_conduct2));
                $sheet->setCellValue('BL'.$numrow, $this->cleanEnter($data->idexx_out_timeout_incubation2));
                $sheet->setCellValue('BM'.$numrow, $this->cleanEnter($data->idexx_out_time_minutes2));
                $sheet->setCellValue('BN'.$numrow, $this->cleanEnter($data->idexx_out_ecoli_largewells2));
                $sheet->setCellValue('BO'.$numrow, $this->cleanEnter($data->idexx_out_ecoli_smallwells2));
                $sheet->setCellValue('BP'.$numrow, $this->cleanEnter($data->idexx_out_ecoli_mpn2));
                $sheet->setCellValue('BQ'.$numrow, $this->cleanEnter($data->idexx_out_coliforms_largewells2));
                $sheet->setCellValue('BR'.$numrow, $this->cleanEnter($data->idexx_out_coliforms_smallwells2));
                $sheet->setCellValue('BS'.$numrow, $this->cleanEnter($data->idexx_out_coliforms_mpn2));
                $sheet->setCellValue('BT'.$numrow, $this->cleanEnter($data->idexx_out_comments2));
                $sheet->setCellValue('BU'.$numrow, $this->cleanEnter($data->metagenomics_date_conduct));
                $sheet->setCellValue('BV'.$numrow, $this->cleanEnter($data->metagenomics_barcode_sample));
                $sheet->setCellValue('BW'.$numrow, $this->cleanEnter($data->metagenomics_barcode_dna1));
                $sheet->setCellValue('BX'.$numrow, $this->cleanEnter($data->metagenomics_weight_sub1));
                $sheet->setCellValue('BY'.$numrow, $this->cleanEnter($data->metagenomics_barcode_storage1));
                $sheet->setCellValue('BZ'.$numrow, $this->cleanEnter($data->metagenomics_position_tube1));
                $sheet->setCellValue('CA'.$numrow, $this->cleanEnter($data->metagenomics_location1));
                $sheet->setCellValue('CB'.$numrow, $this->cleanEnter($data->metagenomics_barcode_dna2));
                $sheet->setCellValue('CC'.$numrow, $this->cleanEnter($data->metagenomics_weight_sub2));
                $sheet->setCellValue('CD'.$numrow, $this->cleanEnter($data->metagenomics_barcode_storage2));
                $sheet->setCellValue('CE'.$numrow, $this->cleanEnter($data->metagenomics_position_tube2));
                $sheet->setCellValue('CF'.$numrow, $this->cleanEnter($data->metagenomics_location2));
                $sheet->setCellValue('CG'.$numrow, $this->cleanEnter($data->metagenomics_comments));
                $sheet->setCellValue('CH'.$numrow, $this->cleanEnter($data->mac1_barcode_macconkey));
                $sheet->setCellValue('CI'.$numrow, $this->cleanEnter($data->mac1_date_process));
                $sheet->setCellValue('CJ'.$numrow, $this->cleanEnter($data->mac1_time_process));
                $sheet->setCellValue('CK'.$numrow, $this->cleanEnter($data->mac1_volume));
                $sheet->setCellValue('CL'.$numrow, $this->cleanEnter($data->mac1_comments));
                $sheet->setCellValue('CM'.$numrow, $this->cleanEnter($data->mac2_date_process));
