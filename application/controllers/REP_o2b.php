    ...
    public function excel()
    {
        ...
        $fileName = 'O2B_bootsock_report_'.$datenow.'.csv';        
            ...
            foreach($rdeliver as $data){ 
                ...
                $sheet->setCellValue('AR'.$numrow, $data->sedi_idexx_barcode_colilert2);
                $sheet->setCellValue('AS'.$numrow, $data->sedi_idexx_volume2);
                $sheet->setCellValue('AT'.$numrow, $data->sedi_idexx_dilution2);
                $sheet->setCellValue('AU'.$numrow, $data->sedi_idexx_time_incubation2);
                $sheet->setCellValue('AV'.$numrow, $data->sedi_idexx_comments2);
                $sheet->setCellValue('AW'.$numrow, $data->idexx_out_date_conduct);
                $sheet->setCellValue('AX'.$numrow, $data->idexx_out_timeout_incubation);
                $sheet->setCellValue('AY'.$numrow, $data->idexx_out_time_minutes);
                $sheet->setCellValue('AZ'.$numrow, $data->idexx_out_ecoli_largewells);
                $sheet->setCellValue('BA'.$numrow, $data->idexx_out_ecoli_smallwells);
                $sheet->setCellValue('BB'.$numrow, $data->idexx_out_ecoli_mpn);
                $sheet->setCellValue('BC'.$numrow, $data->idexx_out_coliforms_largewells);
                $sheet->setCellValue('BD'.$numrow, $data->idexx_out_coliforms_smallwells);
                $sheet->setCellValue('BE'.$numrow, $data->idexx_out_coliforms_mpn);
                $sheet->setCellValue('BF'.$numrow, $data->idexx_out_comments);
                $sheet->setCellValue('BG'.$numrow, $data->idexx_out_date_conduct2);
                $sheet->setCellValue('BH'.$numrow, $data->idexx_out_timeout_incubation2);
                $sheet->setCellValue('BI'.$numrow, $data->idexx_out_time_minutes2);
                $sheet->setCellValue('BJ'.$numrow, $data->idexx_out_ecoli_largewells2);
                $sheet->setCellValue('BK'.$numrow, $data->idexx_out_ecoli_smallwells2);
                $sheet->setCellValue('BL'.$numrow, $data->idexx_out_ecoli_mpn2);
                $sheet->setCellValue('BM'.$numrow, $data->idexx_out_coliforms_largewells2);
                $sheet->setCellValue('BN'.$numrow, $data->idexx_out_coliforms_smallwells2);
                $sheet->setCellValue('BO'.$numrow, $data->idexx_out_coliforms_mpn2);
                $sheet->setCellValue('BP'.$numrow, $data->idexx_out_comments2);
                $sheet->setCellValue('BQ'.$numrow, $data->metagenomics_date_conduct);
                $sheet->setCellValue('BR'.$numrow, $data->metagenomics_barcode_sample);
                $sheet->setCellValue('BS'.$numrow, $data->metagenomics_barcode_dna1);
                $sheet->setCellValue('BT'.$numrow, $data->metagenomics_weight_sub1);
                $sheet->setCellValue('BU'.$numrow, $data->metagenomics_barcode_storage1);
                $sheet->setCellValue('BV'.$numrow, $data->metagenomics_position_tube1);
                $sheet->setCellValue('BW'.$numrow, $data->metagenomics_location1);
                $sheet->setCellValue('BX'.$numrow, $data->metagenomics_barcode_dna2);
                $sheet->setCellValue('BY'.$numrow, $data->metagenomics_weight_sub2);
                $sheet->setCellValue('BZ'.$numrow, $data->metagenomics_barcode_storage2);
                $sheet->setCellValue('CA'.$numrow, $data->metagenomics_position_tube2);
                $sheet->setCellValue('CB'.$numrow, $data->metagenomics_location2);
                $sheet->setCellValue('CC'.$numrow, $data->metagenomics_comments);
                $sheet->setCellValue('CD'.$numrow, $data->mac1_barcode_macconkey);
                $sheet->setCellValue('CE'.$numrow, $data->mac1_date_process);
                $sheet->setCellValue('CF'.$numrow, $data->mac1_time_process);
                $sheet->setCellValue('CG'.$numrow, $data->mac1_volume);
                $sheet->setCellValue('CH'.$numrow, $data->mac1_comments);
                $sheet->setCellValue('CI'.$numrow, $data->mac2_date_process);
                $sheet->setCellValue('CJ'.$numrow, $data->mac2_time_process);
                $sheet->setCellValue('CK'.$numrow, $data->mac2_bar_macsweep1);
                $sheet->setCellValue('CL'.$numrow, $data->mac2_cryobox1);
                $sheet->setCellValue('CM'.$numrow, $data->mac2_bar_macsweep2);
                $sheet->setCellValue('CN'.$numrow, $data->mac2_cryobox2);
                $sheet->setCellValue('CO'.$numrow, $data->mac2_comments); 
