...
class NHMRC_blank_in extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        is_login();
        $this->load->model('NHMRC_blank_in_model');
    ...
    {
        // $this->load->model('NHMRC_blank_in_model');
        // $data['person'] = $this->NHMRC_blank_in_model->getLabtech();
        // $data['type'] = $this->NHMRC_blank_in_model->getSampleType();
        $this->template->load('template','NHMRC_blank_in/index');
    } 
    
    public function json() {
        header('Content-Type: application/json');
        echo $this->NHMRC_blank_in_model->json();
    }
    ...
    public function save() 
    {
        ...
        if ($mode=="insert"){
            ...
            'barcode_endidx' => strtoupper($this->input->post('barcode_endidx',TRUE)),
            ...
            $this->NHMRC_blank_in_model->insert($data);
            ...
            $this->NHMRC_blank_in_model->update($id, $data);
            $this->session->set_flashdata('message', 'Create Record Success');    
        }

        redirect(site_url("NHMRC_blank_in"));
    }

    public function delete($id) 
    {
        $row = $this->NHMRC_blank_in_model->get_by_id($id);
        ...
        if ($row) {
            // $this->NHMRC_blank_in_model->delete($id);
            $this->NHMRC_blank_in_model->update($id, $data);
    ...
    public function valid_bs() 
    {
        ...
        // echo $id;
        $data = $this->NHMRC_blank_in_model->validate1($id);
    ...
    public function excel()
    {
        ...
        $sheet->setCellValue('C1', "Time_incubation");
        $sheet->setCellValue('D1', "Blank_type");
        $sheet->setCellValue('E1', "barcode_end-idx");
        $sheet->setCellValue('F1', "Volume");
        $sheet->setCellValue('G1', "Dilution");
        $sheet->setCellValue('H1', "Comments");
        // $sheet->getStyle('A1:H1')->getFont()->setBold(true); // Set bold kolom A1

        // Panggil function view yang ada di SiswaModel untuk menampilkan semua data siswanya
        $rdeliver = $this->NHMRC_blank_in_model->get_all();
        ...
        foreach($rdeliver as $data){ // Lakukan looping pada variabel siswa
          ...
          $sheet->setCellValue('D'.$numrow, $data->blank_type);
...
/* End of file NHMRC_blank_in.php */
/* Location: ./application/controllers/NHMRC_blank_in.php */
