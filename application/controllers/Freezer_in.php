...
class Freezer_in extends CI_Controller
{
    ...
    public function json() {
        ...
        echo $this->Freezer_in_model->json();
    }
    ...
    {
        $row = $this->Freezer_in_model->get_by_id($id);
    ...
    public function valid_bs() 
    {
        ...
        // echo $id;
        $data = $this->Freezer_in_model->validate1($id);
    ...
    public function excel()
    {
        ...
        $sheet->setCellValue('J1', "Tube_position");
        $sheet->setCellValue('K1', "Comments");
        // $sheet->getStyle('A1:H1')->getFont()->setBold(true); // Set bold kolom A1

        // Panggil function view yang ada di SiswaModel untuk menampilkan semua data siswanya
        $rdeliver = $this->Freezer_in_model->get_all();
        ...
        foreach($rdeliver as $data){ // Lakukan looping pada variabel siswa
          ...
          $sheet->setCellValue('J'.$numrow, $data->tube_position);
    ...
    $datenow=date("Ymd");
    $fileName = 'Freezer_Sample_IN_'.$datenow.'.csv';
...
/* End of file Freezer_in.php */
/* Location: ./application/controllers/Freezer_in.php */
