...
class NHMRC_moisture_48 extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        is_login();
        $this->load->model(['NHMRC_moisture_48_model']);
    ...
    {
        // $this->load->model('NHMRC_moisture_48_model');
        // $data['person'] = $this->NHMRC_moisture_48_model->getLabtech();
        // $data['type'] = $this->NHMRC_moisture_48_model->getSampleType();
        ...
        $this->template->load('template','NHMRC_moisture_48/index');
    } 
    
    public function json() {
        header('Content-Type: application/json');
        echo $this->NHMRC_moisture_48_model->json();
    }
    ...
    public function save() 
    {
        ...
        if ($mode=="insert"){
            ...
            $this->NHMRC_moisture_48_model->insert($data);
            ...
            $this->NHMRC_moisture_48_model->update($id, $data);
            $this->session->set_flashdata('message', 'Create Record Success');    
        }

        redirect(site_url("NHMRC_moisture_48"));
    }

    public function delete($id) 
    {
        $row = $this->NHMRC_moisture_48_model->get_by_id($id);
        ...
        if ($row) {
            // $this->NHMRC_moisture_48_model->delete($id);
            $this->NHMRC_moisture_48_model->update($id, $data);
    ...
    public function load_dry() 
    {
        $id = $this->input->get('id1');
        $data = $this->NHMRC_moisture_48_model->load_dry($id);
        header('Content-Type: application/json');
    ...
    //     $data = $this->NHMRC_moisture_48_model->get_freez($id1, $id2, $id3, $id4);
    //     header('Content-Type: application/json');
    //     echo json_encode($data);
    // }
    ...
    {
        $id = $this->input->get('id1');
        $data = $this->NHMRC_moisture_48_model->validate1($id);
        header('Content-Type: application/json');
        echo json_encode($data);
    }
    ...
    public function excel()
    {
        ...
        $sheet->setCellValue('C1', "Dry_weight(48h)");
        $sheet->setCellValue('D1', "Difference(24n48)");
        $sheet->setCellValue('E1', "Comments");
        // $sheet->getStyle('A1:H1')->getFont()->setBold(true); // Set bold kolom A1

        // Panggil function view yang ada di SiswaModel untuk menampilkan semua data siswanya
        $rdeliver = $this->NHMRC_moisture_48_model->get_all();
    ...
    $datenow=date("Ymd");
    $fileName = 'NHMRC_moisture_48h_'.$datenow.'.csv';
...
/* End of file NHMRC_moisture_48.php */
/* Location: ./application/controllers/NHMRC_moisture_48.php */
