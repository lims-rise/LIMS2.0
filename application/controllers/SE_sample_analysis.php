...
class SE_sample_analysis extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        is_login();
        $this->load->model('SE_sample_analysis_model');
    ...
    {
        // $this->load->model('SE_sample_analysis_model');
        // $data['person'] = $this->SE_sample_analysis_model->getLabtech();
        // $data['type'] = $this->SE_sample_analysis_model->getSampleType();
        // $this->template->load('template','SE_sample_analysis/index', $data);
        $this->template->load('template','SE_sample_analysis/index');
    } 
    
    public function json() {
        header('Content-Type: application/json');
        echo $this->SE_sample_analysis_model->json();
    }
    ...
    public function save() 
    {
        ...
        if ($mode=="insert"){
            ...
            $this->SE_sample_analysis_model->insert($data);
            ...
            $this->SE_sample_analysis_model->update($id, $data);
            $this->session->set_flashdata('message', 'Create Record Success');    
        }

        redirect(site_url("SE_sample_analysis"));
    }

    public function delete($id) 
    {
        $row = $this->SE_sample_analysis_model->get_by_id($id);
        ...
        if ($row) {
            // $this->SE_sample_analysis_model->delete($id);
            $this->SE_sample_analysis_model->update($id, $data);
    ...
    public function valid_bs() 
    {
        ...
        // echo $id;
        $data = $this->SE_sample_analysis_model->validate1($id);
    ...
    public function excel()
    {
        ...
        $sheet->setCellValue('C1', "Description_analysis");
        $sheet->setCellValue('D1', "Person_analysis");
        $sheet->setCellValue('E1', "Comments");
        // $sheet->getStyle('A1:H1')->getFont()->setBold(true); // Set bold kolom A1

        // Panggil function view yang ada di SiswaModel untuk menampilkan semua data siswanya
        $rdeliver = $this->SE_sample_analysis_model->get_all();
    ...
    $datenow=date("Ymd");
    $fileName = 'SE_Sample_Analysis_'.$datenow.'.csv';
...
/* End of file SE_sample_analysis.php */
/* Location: ./application/controllers/SE_sample_analysis.php */
