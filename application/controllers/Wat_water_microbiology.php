...
class Wat_water_microbiology extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        is_login();
        $this->load->model('Wat_water_microbiology_model');
    ...
    {
        // $this->load->model('Wat_water_microbiology_model');
        // $data['person'] = $this->Wat_water_microbiology_model->getLabtech();
        $this->template->load('template','wat_water_microbiology/index');
    } 
    
    public function json() {
        header('Content-Type: application/json');
        echo $this->Wat_water_microbiology_model->json();
    }
    ...
    public function save() 
    {
        ...
        if ($mode=="insert"){
            ...
            $this->Wat_water_microbiology_model->insert($data);
            ...
            $this->Wat_water_microbiology_model->update($id, $data);
            $this->session->set_flashdata('message', 'Create Record Success');    
        }

        redirect(site_url("wat_water_microbiology"));
    }

    public function delete($id) 
    {
        $row = $this->Wat_water_microbiology_model->get_by_id($id);
        ...
        if ($row) {
            // $this->Wat_water_microbiology_model->delete($id);
            $this->Wat_water_microbiology_model->update($id, $data);
    ...
    public function valid_bs()
    {
        ...
        $data = $this->Wat_water_microbiology_model->validate1($id, $type);
        header('Content-Type: application/json');
    ...
    public function excel()
    {
        ...
        $sheet->setCellValue('C1', "Water_lab");
        $sheet->setCellValue('D1', "Parent_barcode");
        $sheet->setCellValue('E1', "Sample_type");
        $sheet->setCellValue('F1', "Total_coliforms");
        $sheet->setCellValue('G1', "Volume_ecoli");
        $sheet->setCellValue('H1', "Comments");
        // $sheet->getStyle('A1:H1')->getFont()->setBold(true); // Set bold kolom A1

        // Panggil function view yang ada di SiswaModel untuk menampilkan semua data siswanya
        $rdeliver = $this->Wat_water_microbiology_model->get_all();
    ...
    $datenow=date("Ymd");
    $fileName = 'Water_Microbiology_'.$datenow.'.csv';
...
/* End of file Wat_water_microbiology.php */
/* Location: ./application/controllers/Wat_water_microbiology.php */
