...
class O2b_metagenomics_wb extends CI_Controller
{
    ...
    public function save() 
    {
        ...
        if ($mode=="insert"){
            ...
            $this->O2b_metagenomics_wb_model->insert_freezer($data);                 
            $id_freezer = $this->O2b_metagenomics_wb_model->get_id_freezer($this->input->post('barcode_dna_bag',TRUE));
            ...
            $this->O2b_metagenomics_wb_model->update_freezer($id_f, $data);               
        }
