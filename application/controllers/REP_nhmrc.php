...
class REP_nhmrc extends CI_Controller
{
    ...
    public function excel()
    {
        ...
        $fileName = 'NHMRC_Toys_'.$datenow.'.csv';            
            ...
            $sheet->setCellValue('F1',"reception_barcode_tinytag");
            $sheet->setCellValue('G1',"reception_comments");
            $sheet->setCellValue('H1',"idexx_in_date_conduct"); 
            $sheet->setCellValue('I1',"idexx_in_time_incubation");
            $sheet->setCellValue('J1',"idexx_in_barcode_colilert1");
            $sheet->setCellValue('K1',"idexx_in_volume1");
            $sheet->setCellValue('L1',"idexx_in_dilution1");
            $sheet->setCellValue('M1',"idexx_in_comments1");
            $sheet->setCellValue('N1',"idexx_in_barcode_colilert2");
            $sheet->setCellValue('O1',"idexx_in_volume2");
            $sheet->setCellValue('P1',"idexx_in_dilution2");
            $sheet->setCellValue('Q1',"idexx_in_comments2");
            $sheet->setCellValue('R1',"idexx_out_date_conduct");
            $sheet->setCellValue('S1',"idexx_out_timeout_incubation");
            $sheet->setCellValue('T1',"idexx_out_time_minutes");
            $sheet->setCellValue('U1',"idexx_out_ecoli_largewells");
            $sheet->setCellValue('V1',"idexx_out_ecoli_smallwells");
            $sheet->setCellValue('W1',"idexx_out_ecoli_mpn");
            $sheet->setCellValue('X1',"idexx_out_coliforms_largewells");
            $sheet->setCellValue('Y1',"idexx_out_coliforms_smallwells");
            $sheet->setCellValue('Z1',"idexx_out_coliforms_mpn");
            $sheet->setCellValue('AA1',"idexx_out_comments");
            $sheet->setCellValue('AB1',"metagenomics_date_conduct");
            $sheet->setCellValue('AC1',"metagenomics_barcode_falcon1");
            $sheet->setCellValue('AD1',"metagenomics_barcode_falcon2");
            $sheet->setCellValue('AE1',"metagenomics_volume_filtered");
            $sheet->setCellValue('AF1',"metagenomics_time_started");
            $sheet->setCellValue('AG1',"metagenomics_time_finished");
            $sheet->setCellValue('AH1',"metagenomics_time_minutes");
            $sheet->setCellValue('AI1',"metagenomics_barcode_dna_bag");
            $sheet->setCellValue('AJ1',"metagenomics_barcode_storage");
            $sheet->setCellValue('AK1',"metagenomics_location");
            $sheet->setCellValue('AL1',"metagenomics_comments");
            $sheet->setCellValue('AM1',"mac1_barcode_macconkey");
            $sheet->setCellValue('AN1',"mac1_date_process");
            $sheet->setCellValue('AO1',"mac1_time_process");
            $sheet->setCellValue('AP1',"mac1_volume");
            $sheet->setCellValue('AQ1',"mac1_comments");
            $sheet->setCellValue('AR1',"mac2_date_process");
            $sheet->setCellValue('AS1',"mac2_time_process");
            $sheet->setCellValue('AT1',"mac2_bar_macsweep1");
            $sheet->setCellValue('AU1',"mac2_cryobox1");
            $sheet->setCellValue('AV1',"macsweep1_location");
            $sheet->setCellValue('AW1',"mac2_bar_macsweep2");
            $sheet->setCellValue('AX1',"mac2_cryobox2");
            ...
            foreach($rdeliver as $data){ 
                ...
                $sheet->setCellValue('F'.$numrow, $this->cleanEnter($data->reception_barcode_tinytag));
                $sheet->setCellValue('G'.$numrow, $this->cleanEnter($data->reception_comments));
                $sheet->setCellValue('H'.$numrow, $this->cleanEnter($data->idexx_in_date_conduct));
                $sheet->setCellValue('I'.$numrow, $this->cleanEnter($data->idexx_in_time_incubation));
                $sheet->setCellValue('J'.$numrow, $this->cleanEnter($data->idexx_in_barcode_colilert1));
                $sheet->setCellValue('K'.$numrow, $this->cleanEnter($data->idexx_in_volume1));
                $sheet->setCellValue('L'.$numrow, $this->cleanEnter($data->idexx_in_dilution1));
                $sheet->setCellValue('M'.$numrow, $this->cleanEnter($data->idexx_in_comments1));
                $sheet->setCellValue('N'.$numrow, $this->cleanEnter($data->idexx_in_barcode_colilert2));
                $sheet->setCellValue('O'.$numrow, $this->cleanEnter($data->idexx_in_volume2));
                $sheet->setCellValue('P'.$numrow, $this->cleanEnter($data->idexx_in_dilution2));
                $sheet->setCellValue('Q'.$numrow, $this->cleanEnter($data->idexx_in_comments2));
                $sheet->setCellValue('R'.$numrow, $this->cleanEnter($data->idexx_out_date_conduct));
                $sheet->setCellValue('S'.$numrow, $this->cleanEnter($data->idexx_out_timeout_incubation));
                $sheet->setCellValue('T'.$numrow, $this->cleanEnter($data->idexx_out_time_minutes));
                $sheet->setCellValue('U'.$numrow, $this->cleanEnter($data->idexx_out_ecoli_largewells));
                $sheet->setCellValue('V'.$numrow, $this->cleanEnter($data->idexx_out_ecoli_smallwells));
                $sheet->setCellValue('W'.$numrow, $this->cleanEnter($data->idexx_out_ecoli_mpn));
                $sheet->setCellValue('X'.$numrow, $this->cleanEnter($data->idexx_out_coliforms_largewells));
                $sheet->setCellValue('Y'.$numrow, $this->cleanEnter($data->idexx_out_coliforms_smallwells));
                $sheet->setCellValue('Z'.$numrow, $this->cleanEnter($data->idexx_out_coliforms_mpn));
                $sheet->setCellValue('AA'.$numrow, $this->cleanEnter($data->idexx_out_comments));
                $sheet->setCellValue('AB'.$numrow, $this->cleanEnter($data->metagenomics_date_conduct));
                $sheet->setCellValue('AC'.$numrow, $this->cleanEnter($data->metagenomics_barcode_falcon1));
                $sheet->setCellValue('AD'.$numrow, $this->cleanEnter($data->metagenomics_barcode_falcon2));
                $sheet->setCellValue('AE'.$numrow, $this->cleanEnter($data->metagenomics_volume_filtered));
                $sheet->setCellValue('AF'.$numrow, $this->cleanEnter($data->metagenomics_time_started));
                $sheet->setCellValue('AG'.$numrow, $this->cleanEnter($data->metagenomics_time_finished));
                $sheet->setCellValue('AH'.$numrow, $this->cleanEnter($data->metagenomics_time_minutes));
                $sheet->setCellValue('AI'.$numrow, $this->cleanEnter($data->metagenomics_barcode_dna_bag));
                $sheet->setCellValue('AJ'.$numrow, $this->cleanEnter($data->metagenomics_barcode_storage));
                $sheet->setCellValue('AK'.$numrow, $this->cleanEnter($data->metagenomics_location));
                $sheet->setCellValue('AL'.$numrow, $this->cleanEnter($data->metagenomics_comments));
                $sheet->setCellValue('AM'.$numrow, $this->cleanEnter($data->mac1_barcode_macconkey));
                $sheet->setCellValue('AN'.$numrow, $this->cleanEnter($data->mac1_date_process));
                $sheet->setCellValue('AO'.$numrow, $this->cleanEnter($data->mac1_time_process));
                $sheet->setCellValue('AP'.$numrow, $this->cleanEnter($data->mac1_volume));
                $sheet->setCellValue('AQ'.$numrow, $this->cleanEnter($data->mac1_comments));
                $sheet->setCellValue('AR'.$numrow, $this->cleanEnter($data->mac2_date_process));
                $sheet->setCellValue('AS'.$numrow, $this->cleanEnter($data->mac2_time_process));
                $sheet->setCellValue('AT'.$numrow, $this->cleanEnter($data->mac2_bar_macsweep1));
                $sheet->setCellValue('AU'.$numrow, $this->cleanEnter($data->mac2_cryobox1));
                $sheet->setCellValue('AV'.$numrow, $this->cleanEnter($data->macsweep1_location));
                $sheet->setCellValue('AW'.$numrow, $this->cleanEnter($data->mac2_bar_macsweep2));
                $sheet->setCellValue('AX'.$numrow, $this->cleanEnter($data->mac2_cryobox2));
                $sheet->setCellValue('AY'.$numrow, $this->cleanEnter($data->macsweep2_location));
                $sheet->setCellValue('AZ'.$numrow, $this->cleanEnter($data->mac2_comments));                          
        ...
        $writer = new \PhpOffice\PhpSpreadsheet\Writer\Csv($spreadsheet);
        $datenow=date("Ymd");
        $fileName = 'NHMRC_Drinking_Water_report_'.$datenow.'.csv';            
        }                    
            ...
            $sheet->setCellValue('G1',"reception_comments");
            $sheet->setCellValue('H1',"stomacher_date_conduct");
            $sheet->setCellValue('I1',"stomacher_barcode_bootsocks_Micro");
            $sheet->setCellValue('J1',"stomacher_elution_number_Micro1");
            $sheet->setCellValue('K1',"stomacher_elution_Micro1");
            $sheet->setCellValue('L1',"stomacher_barcode_falcon_Micro1");
            $sheet->setCellValue('M1',"stomacher_volume_Micro1");
            $sheet->setCellValue('N1',"stomacher_elution_number_Micro2");
            $sheet->setCellValue('O1',"stomacher_elution_Micro2");
            $sheet->setCellValue('P1',"stomacher_barcode_falcon_Micro2");
            $sheet->setCellValue('Q1',"stomacher_volume_Micro2");
            $sheet->setCellValue('R1',"stom_idexx_in_barcode_colilert");
            $sheet->setCellValue('S1',"stom_idexx_in_barcode_falcon1");
            $sheet->setCellValue('T1',"stom_idexx_in_volume_falcon1");
            $sheet->setCellValue('U1',"stom_idexx_in_barcode_falcon2");
            $sheet->setCellValue('V1',"stom_idexx_in_volume_falcon2");
            $sheet->setCellValue('W1',"stom_idexx_in_dilution");
            $sheet->setCellValue('X1',"stom_idexx_in_time_incu_start");
            $sheet->setCellValue('Y1',"stom_idexx_in_comments");
            $sheet->setCellValue('Z1',"idexx_out_date_conduct");
            $sheet->setCellValue('AA1',"idexx_out_timeout_incubation");
            $sheet->setCellValue('AB1',"idexx_out_time_minutes");
            $sheet->setCellValue('AC1',"idexx_out_ecoli_largewells");
            $sheet->setCellValue('AD1',"idexx_out_ecoli_smallwells");
            $sheet->setCellValue('AE1',"idexx_out_ecoli_mpn");
            $sheet->setCellValue('AF1',"idexx_out_coliforms_largewells");
            $sheet->setCellValue('AG1',"idexx_out_coliforms_smallwells");
            $sheet->setCellValue('AH1',"idexx_out_coliforms_mpn");
            $sheet->setCellValue('AI1',"idexx_out_comments");
            $sheet->setCellValue('AJ1',"metagenomics_date_conduct");
            $sheet->setCellValue('AK1',"metagenomics_barcode_falcon1");
            $sheet->setCellValue('AL1',"metagenomics_barcode_falcon2");
            $sheet->setCellValue('AM1',"metagenomics_volume_filtered");
            $sheet->setCellValue('AN1',"metagenomics_time_started");
            $sheet->setCellValue('AO1',"metagenomics_time_finished");
            $sheet->setCellValue('AP1',"metagenomics_time_minutes");
            $sheet->setCellValue('AQ1',"metagenomics_barcode_dna_bag");
            $sheet->setCellValue('AR1',"metagenomics_barcode_storage");
            ...
            foreach($rdeliver as $data){ 
                ...
                $sheet->setCellValue('G'.$numrow, $this->cleanEnter($data->reception_comments));
                $sheet->setCellValue('H'.$numrow, $this->cleanEnter($data->stomacher_date_conduct));
                $sheet->setCellValue('I'.$numrow, $this->cleanEnter($data->stomacher_barcode_bootsocks_Micro));
                $sheet->setCellValue('J'.$numrow, $this->cleanEnter($data->stomacher_elution_number_Micro1));
                $sheet->setCellValue('K'.$numrow, $this->cleanEnter($data->stomacher_elution_Micro1));
                $sheet->setCellValue('L'.$numrow, $this->cleanEnter($data->stomacher_barcode_falcon_Micro1));
                $sheet->setCellValue('M'.$numrow, $this->cleanEnter($data->stomacher_volume_Micro1));
                $sheet->setCellValue('N'.$numrow, $this->cleanEnter($data->stomacher_elution_number_Micro2));
                $sheet->setCellValue('O'.$numrow, $this->cleanEnter($data->stomacher_elution_Micro2));
                $sheet->setCellValue('P'.$numrow, $this->cleanEnter($data->stomacher_barcode_falcon_Micro2));
                $sheet->setCellValue('Q'.$numrow, $this->cleanEnter($data->stomacher_volume_Micro2));
                $sheet->setCellValue('R'.$numrow, $this->cleanEnter($data->stom_idexx_in_barcode_colilert));
                $sheet->setCellValue('S'.$numrow, $this->cleanEnter($data->stom_idexx_in_barcode_falcon1));
                $sheet->setCellValue('T'.$numrow, $this->cleanEnter($data->stom_idexx_in_volume_falcon1));
                $sheet->setCellValue('U'.$numrow, $this->cleanEnter($data->stom_idexx_in_barcode_falcon2));
                $sheet->setCellValue('V'.$numrow, $this->cleanEnter($data->stom_idexx_in_volume_falcon2));
                $sheet->setCellValue('W'.$numrow, $this->cleanEnter($data->stom_idexx_in_dilution));
                $sheet->setCellValue('X'.$numrow, $this->cleanEnter($data->stom_idexx_in_time_incu_start));
                $sheet->setCellValue('Y'.$numrow, $this->cleanEnter($data->stom_idexx_in_comments));
                $sheet->setCellValue('Z'.$numrow, $this->cleanEnter($data->idexx_out_date_conduct));
                $sheet->setCellValue('AA'.$numrow, $this->cleanEnter($data->idexx_out_timeout_incubation));
                $sheet->setCellValue('AB'.$numrow, $this->cleanEnter($data->idexx_out_time_minutes));
                $sheet->setCellValue('AC'.$numrow, $this->cleanEnter($data->idexx_out_ecoli_largewells));
                $sheet->setCellValue('AD'.$numrow, $this->cleanEnter($data->idexx_out_ecoli_smallwells));
                $sheet->setCellValue('AE'.$numrow, $this->cleanEnter($data->idexx_out_ecoli_mpn));
                $sheet->setCellValue('AF'.$numrow, $this->cleanEnter($data->idexx_out_coliforms_largewells));
                $sheet->setCellValue('AG'.$numrow, $this->cleanEnter($data->idexx_out_coliforms_smallwells));
                $sheet->setCellValue('AH'.$numrow, $this->cleanEnter($data->idexx_out_coliforms_mpn));
                $sheet->setCellValue('AI'.$numrow, $this->cleanEnter($data->idexx_out_comments));
                $sheet->setCellValue('AJ'.$numrow, $this->cleanEnter($data->metagenomics_date_conduct));
                $sheet->setCellValue('AK'.$numrow, $this->cleanEnter($data->metagenomics_barcode_falcon1));
                $sheet->setCellValue('AL'.$numrow, $this->cleanEnter($data->metagenomics_barcode_falcon2));
                $sheet->setCellValue('AM'.$numrow, $this->cleanEnter($data->metagenomics_volume_filtered));
                $sheet->setCellValue('AN'.$numrow, $this->cleanEnter($data->metagenomics_time_started));
                $sheet->setCellValue('AO'.$numrow, $this->cleanEnter($data->metagenomics_time_finished));
                $sheet->setCellValue('AP'.$numrow, $this->cleanEnter($data->metagenomics_time_minutes));
                $sheet->setCellValue('AQ'.$numrow, $this->cleanEnter($data->metagenomics_barcode_dna_bag));
                $sheet->setCellValue('AR'.$numrow, $this->cleanEnter($data->metagenomics_barcode_storage));
        ...
        $writer = new \PhpOffice\PhpSpreadsheet\Writer\Csv($spreadsheet);
        $datenow=date("Ymd");
        $fileName = 'NHMRC_Swab_Indoor_report_'.$datenow.'.csv';            
        }        
